    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <button
          ...
          className="flex flex-col rounded-xl border-2 border-border p-6 text-left transition hover:border-green-400 hover:bg-green-50/50"
        >
        ...
        <button
          ...
          disabled={uploading}
          className="flex flex-col rounded-xl border-2 border-border p-6 text-left transition hover:border-green-400 hover:bg-green-50/50 disabled:opacity-60"
        >
        ...
        <div className="flex flex-col rounded-xl border-2 border-dashed border-border p-6 opacity-60">
