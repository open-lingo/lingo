...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  },
  {
    ...
    category: "cosmetics",
    consumable: false,
    titleKey: "titleEarlyBird.title",
    descriptionKey: "titleEarlyBird.description",
    iconName: "crown",
    titleId: "title-early-bird",
  },
  {
    id: "title-bookworm",
    price: 75,
    category: "cosmetics",
    consumable: false,
    titleKey: "titleBookworm.title",
    descriptionKey: "titleBookworm.description",
    iconName: "crown",
    titleId: "title-bookworm",
  },
  {
    id: "title-wanderer",
    price: 75,
    category: "cosmetics",
    consumable: false,
    titleKey: "titleWanderer.title",
    descriptionKey: "titleWanderer.description",
    iconName: "crown",
    titleId: "title-wanderer",
  },
  {
    id: "title-polyglot",
    price: 150,
    category: "cosmetics",
    consumable: false,
    titleKey: "titlePolyglot.title",
    descriptionKey: "titlePolyglot.description",
    iconName: "crown",
    titleId: "title-polyglot",
  },
  {
    id: "title-linguist",
    price: 150,
    category: "cosmetics",
    consumable: false,
    titleKey: "titleLinguist.title",
    descriptionKey: "titleLinguist.description",
    iconName: "crown",
    titleId: "title-linguist",
  },
  {
    id: "title-wordsmith",
    price: 200,
    category: "cosmetics",
    consumable: false,
    titleKey: "titleWordsmith.title",
    descriptionKey: "titleWordsmith.description",
    iconName: "crown",
    titleId: "title-wordsmith",
  },
  {
    ...
    category: "cosmetics",
    consumable: false,
    titleKey: "titleGlobetrotter.title",
    descriptionKey: "titleGlobetrotter.description",
    iconName: "crown",
    titleId: "title-globetrotter",
  },
  {
    id: "title-sensei",
    price: 300,
    category: "cosmetics",
    consumable: false,
    titleKey: "titleSensei.title",
    descriptionKey: "titleSensei.description",
    iconName: "crown",
    titleId: "title-sensei",
  },
