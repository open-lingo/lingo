...
import { REACTION_EMOJI, type ActivityReaction, type ReactionKind } from "../mock/mockSocial";
...
export function ReactionRow({
  ...
  // Local overrides on top of the incoming reactions. We keep a delta map
  // so the rendered count is `initial + (mine ? +1 : 0) - (was-mine ? 1 : 0)`.
  // Simplest model: a Set of kinds I've toggled-on locally + a Set I've
  // toggled-off (to remove an initial `mine: true`).
