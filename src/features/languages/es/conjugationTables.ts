...
export const ES_VERB_ENTRIES: EsVerbEntry[] = [
  ...
  },
  {
    ...
    meaning: "to work",
    group: "ar",
    introducedAtModule: 10, // M10 — taught as a word (trabajo / trabajas / trabaja); preterite drilled at m19
    forms: {
      "present.yo": "trabajo",
      "present.tu": "trabajas",
      "present.el": "trabaja",
      "present.nosotros": "trabajamos",
      "present.vosotros": "trabajáis",
      "present.ustedes": "trabajan",
      "preterite.yo": "trabajé",
      "preterite.tu": "trabajaste",
      "preterite.el": "trabajó",
      "preterite.nosotros": "trabajamos",
      "preterite.vosotros": "trabajasteis",
      "preterite.ustedes": "trabajaron",
      "imperfect.yo": "trabajaba",
      "imperfect.tu": "trabajabas",
      "imperfect.el": "trabajaba",
      "imperfect.nosotros": "trabajábamos",
      "imperfect.vosotros": "trabajabais",
      "imperfect.ustedes": "trabajaban",
    },
  },
  {
    id: "estudiar",
    ...
    meaning: "to study",
    group: "ar",
    introducedAtModule: 10, // M10; preterite drilled at m19
    forms: {
      "present.yo": "estudio",
      "present.tu": "estudias",
      "present.el": "estudia",
      "present.nosotros": "estudiamos",
      "present.vosotros": "estudiáis",
      "present.ustedes": "estudian",
      "preterite.yo": "estudié",
      "preterite.tu": "estudiaste",
      "preterite.el": "estudió",
      "preterite.nosotros": "estudiamos",
      "preterite.vosotros": "estudiasteis",
      "preterite.ustedes": "estudiaron",
      "imperfect.yo": "estudiaba",
      "imperfect.tu": "estudiabas",
      "imperfect.el": "estudiaba",
      "imperfect.nosotros": "estudiábamos",
      "imperfect.vosotros": "estudiabais",
      "imperfect.ustedes": "estudiaban",
    },
  },
  {
    id: "comprar",
    ...
    meaning: "to buy",
    group: "ar",
    introducedAtModule: 12, // M12 (infinitive) / M16 (singular cells); preterite drilled at m19
    forms: {
      "present.yo": "compro",
      "present.tu": "compras",
      "present.el": "compra",
      "present.nosotros": "compramos",
      "present.vosotros": "compráis",
      "present.ustedes": "compran",
      "preterite.yo": "compré",
      "preterite.tu": "compraste",
      "preterite.el": "compró",
      "preterite.nosotros": "compramos",
      "preterite.vosotros": "comprasteis",
      "preterite.ustedes": "compraron",
      "imperfect.yo": "compraba",
      "imperfect.tu": "comprabas",
      "imperfect.el": "compraba",
      "imperfect.nosotros": "comprábamos",
      "imperfect.vosotros": "comprabais",
      "imperfect.ustedes": "compraban",
    },
  },
  {
    id: "escribir",
    ...
    meaning: "to write",
    group: "ir",
    introducedAtModule: 11, // M11 (infinitive); preterite drilled at m19
    forms: {
      "present.yo": "escribo",
      "present.tu": "escribes",
      "present.el": "escribe",
      "present.nosotros": "escribimos",
      "present.vosotros": "escribís",
      "present.ustedes": "escriben",
      "preterite.yo": "escribí",
      "preterite.tu": "escribiste",
      "preterite.el": "escribió",
      "preterite.nosotros": "escribimos",
      "preterite.vosotros": "escribisteis",
      "preterite.ustedes": "escribieron",
      "imperfect.yo": "escribía",
      "imperfect.tu": "escribías",
      "imperfect.el": "escribía",
      "imperfect.nosotros": "escribíamos",
      "imperfect.vosotros": "escribíais",
      "imperfect.ustedes": "escribían",
    },
  },
  {
    id: "salir",
    ...
    group: "irregular",
    introducedAtModule: 15, // M15 — yo-irregular salgo; preterite (regular) drilled at m19
    forms: {
      "present.yo": "salgo",
      "present.tu": "sales",
      "present.el": "sale",
      "present.nosotros": "salimos",
      "present.vosotros": "salís",
      "present.ustedes": "salen",
      "preterite.yo": "salí",
      "preterite.tu": "saliste",
      "preterite.el": "salió",
      "preterite.nosotros": "salimos",
      "preterite.vosotros": "salisteis",
      "preterite.ustedes": "salieron",
      "imperfect.yo": "salía",
      "imperfect.tu": "salías",
      "imperfect.el": "salía",
      "imperfect.nosotros": "salíamos",
      "imperfect.vosotros": "salíais",
      "imperfect.ustedes": "salían",
    },
  },
  {
    id: "cocinar",
    ...
    meaning: "to cook",
    group: "ar",
    introducedAtModule: 13, // M13 (infinitive); m19's L8 transfer cell «cociné»
    forms: {
      "present.yo": "cocino",
      "present.tu": "cocinas",
      "present.el": "cocina",
      "present.nosotros": "cocinamos",
      "present.vosotros": "cocináis",
      "present.ustedes": "cocinan",
      "preterite.yo": "cociné",
      "preterite.tu": "cocinaste",
      "preterite.el": "cocinó",
      "preterite.nosotros": "cocinamos",
      "preterite.vosotros": "cocinasteis",
      "preterite.ustedes": "cocinaron",
      "imperfect.yo": "cocinaba",
      "imperfect.tu": "cocinabas",
      "imperfect.el": "cocinaba",
      "imperfect.nosotros": "cocinábamos",
      "imperfect.vosotros": "cocinabais",
      "imperfect.ustedes": "cocinaban",
    },
  },
  {
    id: "ver",
    ...
    meaning: "to see",
    group: "irregular",
    introducedAtModule: 16, // M16 Lo veo («veo»); preterite vi/viste/vio for m20 (pin E12)
    forms: {
      "present.yo": "veo",
      "present.tu": "ves",
      "present.el": "ve",
      "present.nosotros": "vemos",
      "present.vosotros": "veis",
      "present.ustedes": "ven",
      "preterite.yo": "vi",
      "preterite.tu": "viste",
      "preterite.el": "vio",
      "preterite.nosotros": "vimos",
      "preterite.vosotros": "visteis",
      "preterite.ustedes": "vieron",
      "imperfect.yo": "veía",
      "imperfect.tu": "veías",
      "imperfect.el": "veía",
      "imperfect.nosotros": "veíamos",
      "imperfect.vosotros": "veíais",
      "imperfect.ustedes": "veían",
    },
  },
  {
    id: "venir",
    ...
    meaning: "to come",
    group: "irregular",
    introducedAtModule: 15, // M15 Hago, vengo («vengo», «viene»); preterite vine/vino for m20 (pin E12)
    forms: {
      "present.yo": "vengo",
      "present.tu": "vienes",
      "present.el": "viene",
      "present.nosotros": "venimos",
      "present.vosotros": "venís",
      "present.ustedes": "vienen",
      "preterite.yo": "vine",
      "preterite.tu": "viniste",
      "preterite.el": "vino",
      "preterite.nosotros": "vinimos",
      "preterite.vosotros": "vinisteis",
      "preterite.ustedes": "vinieron",
      "imperfect.yo": "venía",
      "imperfect.tu": "venías",
      "imperfect.el": "venía",
      "imperfect.nosotros": "veníamos",
      "imperfect.vosotros": "veníais",
      "imperfect.ustedes": "venían",
    },
  },
];
