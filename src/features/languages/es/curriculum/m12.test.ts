...
// m12 predates the bar (hand-authored July wave); measured debt is pinned
...
registerEsModuleBarGuards({
  ...
  debt: { unknownTokens: 101, nonIntroDebuts: 5, fullSentenceMcqs: 12, progressiveGlosses: 1, imageMcqReuse: 2, particleClozeOutOfModule: 1, translateShare: 0.178 },
});
