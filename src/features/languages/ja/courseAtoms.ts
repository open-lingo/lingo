...
const JA_COURSE_ATOMS_PART1: readonly CourseAtom[] = [
  ...
  { id: "firumu", kana: "フィルム", romaji: "firumu", meaningEn: "roll of movie", emoji: "🎞️", fromModule: "future", freqRank: 83, kind: "vocab", pos: "noun" },
  ...
  { id: "okashi", kana: "おかし", kanji: "お菓子", romaji: "okashi", meaningEn: "candy, candy", emoji: "🍬", fromModule: "m31", kind: "vocab", blocked: true, note: "blocked — 🍬 is also あまい, さとう and あめ (candy)", pos: "noun" },
  ...
  { id: "ojiisan", kana: "おじいさん", kanji: "祖父", romaji: "ojiisan", meaningEn: "grandfather, male senior citizen", emoji: "👴", fromModule: "m17", kind: "vocab", note: "older man; taught m17 Pack 9 (2026-09-10) as a generic elderly-man noun. kanji corrected 伯父/叔父 (uncle) → 祖父 (grandfather) to match the gloss — the old value was a mislabel", pos: "noun" },
  ...
  { id: "hirugohan", kana: "ひるごはん", kanji: "昼ご飯", romaji: "hirugohan", meaningEn: "midday meal", emoji: "🍱", fromModule: "future", freqRank: 214, kind: "vocab", note: "bento reads as midday meal", pos: "noun" },
  ...
  { id: "oriru", kana: "おりる", kanji: "降りる", romaji: "oriru", meaningEn: "to get off, to descend", emoji: "⬇️", fromModule: "m19", kind: "vocab", note: "down-arrow = descend; taught m19 Pack 8 (2026-09-10), pack 7 leftover", pos: "verb", conjugation: { class: "ichidan", entryId: "oriru" } },
...
const JA_COURSE_ATOMS_PART2: readonly CourseAtom[] = [
  ...
  { id: "ikimasen", kana: "いきません", romaji: "ikimasen", meaningEn: "don't go, not traveling (polite)", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  ...
  { id: "sonomama", kana: "そのまま", romaji: "sonomama", meaningEn: "just like that, exactly as it is", shortGloss: "just as is", fromModule: "m46", introducedByLessonId: "ja-m46-neo-8", kind: "vocab", blocked: true, note: "fused その (m1, already known) + まま; abstract manner expression, no single-frame picture. Kana-only per this module's conservative kanji list", pos: "expression" },
