...
const JA_COURSE_ATOMS_PART1: readonly CourseAtom[] = [
  ...
  { id: "iro", kana: "いろ", kanji: "色", romaji: "iro", meaningEn: "color", emoji: "🎨", fromModule: "m1", introducedByLessonId: "ja-m1-l9-ra", kind: "vocab", note: "palette = color", pos: "noun" },
  ...
  { id: "sanpo", kana: "さんぽ", kanji: "散歩", romaji: "sanpo", meaningEn: "walk", emoji: "🚶", fromModule: "m5", kind: "vocab", pos: "noun" },
  ...
  { id: "paatii", kana: "パーティー", romaji: "paatii", meaningEn: "party", emoji: "🎉", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "Extension katakana (ティ) — never base-readable in the M3-M12 gojūon rollout; accept-romaji only. `introducedByLessonId` previously pointed at ja-m23-2-2, a DEAD attribution (exists only in curriculum/_archive/m23.ts, never in the live m23 neo module — same class as m41's own haru-stick fix); re-stamped to m41's actual live debut. `freqRank` dropped on landing (frequencyAtoms.test.ts: that field is deck-overflow-queue-only, valid solely on fromModule:'future' rows). Marked `blocked` on landing here: the modern IR compiler (m11+) has no word_image_mcq emission path (inv 30 needs one), so an unblocked emoji atom cannot clear the debut-type bar under this pipeline — same all-blocked accommodation m39/m40/m41's own new atoms already use; the 🎉 emoji field is kept as a harmless label, not a debut promise.", pos: "noun" },
  ...
  { id: "genki", kana: "げんき", kanji: "元気", romaji: "genki", meaningEn: "health", emoji: "💪", fromModule: "m2", introducedByLessonId: "ja-m2-g", kind: "vocab", note: "flexed bicep as vitality cue", pos: "adjective", conjugation: { class: "na-adj", entryId: "genki" } },
  { id: "shashin", kana: "しゃしん", kanji: "写真", romaji: "shashin", meaningEn: "photo", emoji: "📷", fromModule: "m2", introducedByLessonId: "ja-m2-yoon-sh-ch", kind: "vocab", pos: "noun" },
  ...
  { id: "ryouri", kana: "りょうり", kanji: "料理", romaji: "ryouri", meaningEn: "food, cooking", emoji: "🍱", fromModule: "m2", introducedByLessonId: "ja-m2-yoon-rare", kind: "vocab", note: "bento as cuisine proxy; meaningEn leads with 'food' (matchTileGloss splits on comma) because every IR sentence glosses 料理 as the noun-object sense — 'the food wasn't delicious' (m12/m13) — not the gerund/activity sense (fb16 audit fix 2026-09-15)", pos: "noun" },
  ...
  { id: "denwa", kana: "でんわ", kanji: "電話", romaji: "denwa", meaningEn: "phone", emoji: "📞", fromModule: "m2", introducedByLessonId: "ja-m2-d", kind: "vocab", pos: "noun" },
  ...
  { id: "resutoran", kana: "レストラン", romaji: "resutoran", meaningEn: "restaurant", emoji: "🍽️", fromModule: "future", freqRank: 310, kind: "vocab", note: "Restamped 'future' 2026-09-15 (TestFlight #127 follow-up): the ja-m12-kata attribution was false — that lesson's コンビニ listening_comp only uses \"restaurant\" as an ENGLISH distractor label; the kana レストラン never appears in any live lesson's steps (m39's reviewPool draw on it was already dropped 2026-09-15, reviewWindowFloor investigation, m39.ir.yaml). No lesson currently teaches it — same convention as とる/取る, でも, した/きた.", pos: "noun" },
  ...
  { id: "arigatou-casual", kana: "ありがとう", romaji: "arigatou", meaningEn: "thanks", fromModule: "m3", introducedByLessonId: "ja-m3-neo-5", kind: "phrase", note: "m3-neo pilot: casual thanks — register pair with ありがとうございます, taught as a chunk (guide type 5). Found untracked by the 2026-07-20 vocab-provenance audit.", pos: "expression" },
  ...
  { id: "ja-m4-1-v-kaban", kana: "かばん", romaji: "kaban", meaningEn: "bag", emoji: "👜", fromModule: "m2", introducedByLessonId: "ja-m4-1", kind: "vocab", pos: "noun" },
  ...
  { id: "ja-m4-1-v-keitai", emoji: "📱", kana: "けいたい", romaji: "keitai", meaningEn: "Cell phone", fromModule: "m4", introducedByLessonId: "ja-m4-1", kind: "vocab", pos: "noun" },
  ...
  { id: "ja-m4-3-v-jitensha", kana: "じてんしゃ", kanji: "自転車", romaji: "jitensha", meaningEn: "bike", emoji: "🚲", fromModule: "m4", introducedByLessonId: "ja-m4-3", kind: "vocab", pos: "noun" },
  ...
  { id: "ja-m5-7-v-arigatou", kana: "ありがとうございます", romaji: "arigatou gozaimasu", meaningEn: "Thank you", fromModule: "m3", introducedByLessonId: "ja-m3-neo-5", kind: "phrase", note: "m5→m3 (2026-08-20 drift guard): the m3-neo-5 phrases lesson is the real teach (audio primer lc-arigatou); the old ja-m5-7 pointer was dangling", pos: "expression" },
  ...
  { id: "arimasu", kana: "あります", romaji: "arimasu", meaningEn: "there is", emoji: "📦", fromModule: "m6", introducedByLessonId: "ja-m7-neo-7", kind: "vocab", pos: "verb" },
  { id: "imasu", kana: "います", romaji: "imasu", meaningEn: "there is / there are (people, animals)", emoji: "🧑", fromModule: "future", freqRank: 9, introducedByLessonId: "ja-m6-2-1", kind: "vocab", note: "mirrors sibling arimasu's animate-existential distinction — います needs an existential がいます frame, not the copula です/だ (fb16 audit fix 2026-09-15)", pos: "verb" },
  ...
  { id: "p-ni", kana: "に", romaji: "ni", meaningEn: "to / at", fromModule: "m6", introducedByLessonId: "ja-m6-2-1", kind: "particle", pos: "particle" },
  { id: "ja-m6-1-konbini", emoji: "🏪", kana: "コンビニ", romaji: "konbini", meaningEn: "Convenience store", fromModule: "m19", kind: "vocab", note: "Exposed (romaji) in m6; re-homed 2026-09-10 (Pack 8) off the retired ja-m12-kata lesson — its introducedByLessonId was dangling (that lesson is off-map, never rendered) and left コンビニ never-graded/never-touched. m19 is now the live teaching module.", pos: "noun" },
  { id: "ja-m6-1-toire", kana: "トイレ", romaji: "toire", meaningEn: "restroom", emoji: "🚽", fromModule: "m11", introducedByLessonId: "ja-m11-kata", kind: "vocab", note: "Exposed in m6, SRS-attributed to m11 where レ (ラ row) makes トイレ base-readable (spec §4.2). Unlocks on ja-m11-kata.", pos: "noun" },
  ...
  { id: "chikatetsu", kana: "ちかてつ", kanji: "地下鉄", romaji: "chikatetsu", meaningEn: "subway train", emoji: "🚇", fromModule: "m19", introducedByLessonId: "ja-m6-1-1", kind: "vocab", pos: "noun" },
  ...
  { id: "ja-m6-1-mise", kana: "みせ", kanji: "店", romaji: "mise", meaningEn: "store", emoji: "🏪", fromModule: "m8", introducedByLessonId: "ja-m6-1", kind: "vocab", pos: "noun" },
  ...
  { id: "densha", kana: "でんしゃ", kanji: "電車", romaji: "densha", meaningEn: "train", emoji: "🚆", fromModule: "m19", introducedByLessonId: "ja-m6-3-1", kind: "vocab", pos: "noun" },
  ...
  { id: "ikimasu", kana: "いきます", romaji: "ikimasu", meaningEn: "go", emoji: "🚶", fromModule: "m7", introducedByLessonId: "ja-m7-neo-2", kind: "vocab", pos: "verb" },
  ...
  { id: "kakimasu", kana: "かきます", romaji: "kakimasu", meaningEn: "write", emoji: "✍️", fromModule: "future", freqRank: 12, introducedByLessonId: "ja-m7-2-1", kind: "vocab", pos: "verb" },
  { id: "ja-m7-8-warm-kashikomari", kana: "かしこまりました", romaji: "kashikomarimashita", meaningEn: "Understood.", fromModule: "future", introducedByLessonId: "ja-m7-8", kind: "phrase", pos: "expression" },
  { id: "ja-m7-8-warm-gochuumon", kana: "ごちゅうもんは", romaji: "go-chuumon wa", meaningEn: "Your order?", fromModule: "future", introducedByLessonId: "ja-m7-8", kind: "phrase", pos: "expression" },
  ...
  { id: "tabemasu", kana: "たべます", romaji: "tabemasu", meaningEn: "eat", emoji: "🍴", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  ...
  { id: "nomimasu", kana: "のみます", romaji: "nomimasu", meaningEn: "drink", emoji: "🥤", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "mimasu", kana: "みます", romaji: "mimasu", meaningEn: "watch", emoji: "👀", fromModule: "m7", introducedByLessonId: "ja-m7-neo-2", kind: "vocab", pos: "verb" },
  { id: "yomimasu", kana: "よみます", romaji: "yomimasu", meaningEn: "read", emoji: "📚", fromModule: "future", freqRank: 14, introducedByLessonId: "ja-m7-2-1", kind: "vocab", pos: "verb" },
  { id: "ja-m7-2-ex-1", kana: "わたしは すしを たべます", romaji: "watashi wa sushi wo tabemasu", meaningEn: "I eat sushi.", fromModule: "future", introducedByLessonId: "ja-m7-2", kind: "phrase", pos: "expression" },
  { id: "ja-m7-2-ex-2", kana: "わたしは ほんを よみます", romaji: "watashi wa hon wo yomimasu", meaningEn: "I read a book.", fromModule: "future", introducedByLessonId: "ja-m7-2", kind: "phrase", pos: "expression" },
  ...
  { id: "osake", kana: "おさけ", kanji: "お酒", romaji: "osake", meaningEn: "alcohol", emoji: "🍶", fromModule: "m21", introducedByLessonId: "ja-m7-1-1", kind: "vocab", pos: "noun" },
  { id: "ja-m7-4-v-gohan", kana: "ごはん", kanji: "ご飯", romaji: "gohan", meaningEn: "cooked rice, meal", emoji: "🍚", fromModule: "m2", introducedByLessonId: "ja-m7-4", kind: "vocab", pos: "noun" },
  ...
  { id: "ja-m7-1-v-iku", kana: "いく", kanji: "行く", romaji: "iku", meaningEn: "to go, to travel", emoji: "🚶", fromModule: "m5", introducedByLessonId: "ja-m7-1", kind: "vocab", note: "person walking; meaningEn keeps the 'to travel' clause — matchTileGloss splits on comma so the taught tile still reads just 'to go', but 5 modules' past/volitional/conditional derived forms (いった/いきました/いこう/いけば/いくなら/いきたがっている/いかなかった/いきませんでした) anchor on 'travel' because English go/went/going don't share a 3+ letter stem for the gloss-mismatch check to match on (fb16 gate fix 2026-09-15)", pos: "verb", conjugation: { class: "godan", entryId: "iku" } },
  ...
  { id: "ja-surv-desu", kana: "です", romaji: "desu", meaningEn: "is / are", fromModule: "m7", introducedByLessonId: "ja-m7-neo-4", kind: "phrase", pos: "expression" },
  ...
  { id: "abiru", kana: "あびる", romaji: "abiru", meaningEn: "to shower", emoji: "🚿", fromModule: "future", freqRank: 17, kind: "vocab", pos: "verb", conjugation: { class: "ichidan", entryId: "abiru" } },
  ...
  { id: "obaasan", kana: "おばあさん", romaji: "obaasan", meaningEn: "grandmother, female senior-citizen", emoji: "👵", fromModule: "m17", kind: "vocab", note: "taught m17 Pack 9 (2026-09-10) as a generic elderly-woman noun (describing people, not a うち family address term — m17's own family-register ruling keeps that set to はは/あね only)", pos: "noun" },
  { id: "omawarisan", kana: "おまわりさん", romaji: "omawarisan", meaningEn: "police officer", emoji: "👮", fromModule: "future", freqRank: 22, introducedByLessonId: "ja-m17-8-2", kind: "vocab", pos: "noun" },
  ...
  { id: "kotchi", kana: "こっち", romaji: "kotchi", meaningEn: "this way", fromModule: "future", freqRank: 24, kind: "vocab", blocked: true, note: "demonstrative — spatial pronoun", pos: "pronoun" },
  ...
  { id: "ja--jaa", kana: "じゃあ", romaji: "jaa", meaningEn: "well then…", fromModule: "m41", introducedByLessonId: "ja-m41-neo-6", kind: "vocab", blocked: true, note: "discourse particle. `introducedByLessonId` previously pointed at ja-m26-5-2, a DEAD attribution (exists only in curriculum/_archive/m26.ts, never in the live m26 neo module — same class as m41's own haru-stick/paatii fixes); re-stamped to m41's actual live debut. `kana` was also simplified from the broken \"じゃ / じゃあ\" (a literal slash-and-space string the tokenizer can never match as either word) down to plain じゃあ — bare じゃ is never used standalone anywhere live in the course, only inside じゃない/じゃなかった, which are unrelated m12 grammar-chunk atoms.", pos: "conjunction" },
  { id: "suguni", kana: "すぐに", romaji: "suguni", meaningEn: "immediately", emoji: "⚡", fromModule: "future", freqRank: 29, introducedByLessonId: "ja-m17-8-2", kind: "vocab", note: "lightning = instant", pos: "adverb" },
  ...
  { id: "soredeha", kana: "それでは", romaji: "soredeha", meaningEn: "well then", fromModule: "future", freqRank: 35, kind: "vocab", blocked: true, note: "discourse connector", pos: "conjunction" },
  ...
  { id: "chotto", kana: "ちょっと", romaji: "chotto", meaningEn: "a bit", fromModule: "m10", kind: "vocab", blocked: true, note: "adverb/abstract degree marker", pos: "adverb" },
  ...
  { id: "deha", kana: "では", romaji: "deha", meaningEn: "well then", fromModule: "m26", introducedByLessonId: "ja-m26-5-2", kind: "vocab", blocked: true, note: "particle/conjunction", pos: "conjunction" },
  ...
  { id: "doushite", kana: "どうして", romaji: "doushite", meaningEn: "why", fromModule: "m27", introducedByLessonId: "ja-m13-4-2", kind: "vocab", blocked: true, note: "interrogative", pos: "adverb" },
  ...
  { id: "donata", kana: "どなた", romaji: "donata", meaningEn: "who", fromModule: "m17", kind: "vocab", blocked: true, note: "interrogative pronoun — per rubric; taught m17 Pack 9 (2026-09-10) on the dare/polite rule card. Re-homed off dangling introducedByLessonId ja-m19-4-2 (dead, B068 class)", pos: "pronoun" },
  ...
  { id: "nado", kana: "など", romaji: "nado", meaningEn: "and so on", fromModule: "m21", introducedByLessonId: "ja-m21-3-2", kind: "vocab", blocked: true, note: "particle", pos: "noun" },
  ...
  { id: "haku", kana: "はく", romaji: "haku", meaningEn: "to wear (on lower body)", emoji: "👖", fromModule: "future", freqRank: 49, kind: "vocab", note: "jeans as put-on-trousers cue", pos: "verb", conjugation: { class: "godan" } },
  ...
  { id: "mazui", kana: "まずい", romaji: "mazui", meaningEn: "tastes bad", emoji: "🤢", fromModule: "future", freqRank: 54, kind: "vocab", note: "nauseated face for bad-taste cue", pos: "adjective", conjugation: { class: "i-adj", entryId: "mazui" } },
  ...
  { id: "erebeetaa", kana: "エレベーター", romaji: "erebeetaa", meaningEn: "elevator", emoji: "🛗", fromModule: "m33", kind: "vocab", pos: "noun" },
  ...
  { id: "kiro--kiromeetoru", kana: "キロ / キロメートル", romaji: "kiro-/-kiromeetoru", meaningEn: "kilometer", fromModule: "future", freqRank: 64, kind: "vocab", blocked: true, note: "unit of measure; no referent", pos: "noun" },
  ...
  { id: "supootsu", kana: "スポーツ", romaji: "supootsu", meaningEn: "sports", emoji: "⚽", fromModule: "m16", kind: "vocab", note: "soccer ball as sport proxy. Taught by m16 vocab pack 6 2026-07-30 (B067); was m15", pos: "noun" },
  ...
  { id: "zubon", kana: "ズボン", romaji: "zubon", meaningEn: "pants", emoji: "👖", fromModule: "future", freqRank: 74, kind: "vocab", pos: "noun" },
  { id: "seetaa", kana: "セーター", romaji: "seetaa", meaningEn: "sweater", emoji: "🧥", fromModule: "future", freqRank: 75, kind: "vocab", pos: "noun" },
  ...
  { id: "nooto", kana: "ノート", romaji: "nooto", meaningEn: "notebook", emoji: "📓", fromModule: "m16", kind: "vocab", note: "taught by m16 vocab pack 5 2026-07-30 (B067); was m7 attributed to ja-m7-kata (a RETIRED old-course kata lesson on no map tile — the ドア/ja-m6-kata class) — deleted so the fallback attributes it", pos: "noun" },
  ...
  { id: "firumu", kana: "フィルム", romaji: "firumu", meaningEn: "film", emoji: "🎞️", fromModule: "future", freqRank: 83, kind: "vocab", pos: "noun" },
  ...
  { id: "posuto", kana: "ポスト", romaji: "posuto", meaningEn: "mailbox", emoji: "📮", fromModule: "future", freqRank: 91, kind: "vocab", note: "postbox", pos: "noun" },
  ...
  { id: "meetoru", kana: "メートル", romaji: "meetoru", meaningEn: "meter", emoji: "📏", fromModule: "future", freqRank: 93, kind: "vocab", note: "ruler", pos: "noun" },
  ...
  { id: "oniisan", kana: "おにいさん", kanji: "お兄さん", romaji: "oniisan", meaningEn: "older brother", emoji: "👨", fromModule: "m21", blocked: true, kind: "vocab", note: "man + kanji 兄; no picture debut (inv-30 census 2026-08-20): named first by its own module's rule card, which compiles to a pinned step no debut MCQ can precede (m20/m21 card-steals-the-picture rule; netsu precedent)", pos: "noun" },
  { id: "oneesan", kana: "おねえさん", kanji: "お姉さん", romaji: "oneesan", meaningEn: "older sister", emoji: "👩", fromModule: "m21", blocked: true, kind: "vocab", note: "woman; kanji 姉 carries 'older'; no picture debut (inv-30 census 2026-08-20): あね's 👩 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)", pos: "noun" },
  ...
  { id: "okaasan", kana: "おかあさん", kanji: "お母さん", romaji: "okaasan", meaningEn: "mother", emoji: "👩", fromModule: "m21", blocked: true, kind: "vocab", note: "woman; pair with phrase context; no picture debut (inv-30 census 2026-08-20): あね's 👩 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)", pos: "noun" },
  { id: "otousan", kana: "おとうさん", kanji: "お父さん", romaji: "otousan", meaningEn: "father", emoji: "👨", fromModule: "m21", kind: "vocab", blocked: true, note: "man glyph reads as 'man' not 'father'; rubric flags parent words", pos: "noun" },
  ...
  { id: "toriniku", kana: "とりにく", kanji: "とり肉", romaji: "toriniku", meaningEn: "chicken", emoji: "🍗", fromModule: "m13", kind: "vocab", pos: "noun" },
  ...
  { id: "narabu", kana: "ならぶ", kanji: "並ぶ", romaji: "narabu", meaningEn: "to line up, to stand in a line", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no single-glyph for line-up; abstract action — re-stamped future → m41, the transitivity family's tenth pair (ならぶ／ならべる). `freqRank` dropped on landing (frequencyAtoms.test.ts: deck-overflow-queue-only field, valid solely on `fromModule: \"future\"` rows).", pos: "verb", conjugation: { class: "godan" } },
  { id: "naraberu", kana: "ならべる", kanji: "並べる", romaji: "naraberu", meaningEn: "to line up, to set up", emoji: "📊", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no clean glyph for 'arrange in a row'; risk of confusion — re-stamped future → m41, the transitivity family's tenth pair (ならぶ／ならべる). `freqRank` dropped on landing (frequencyAtoms.test.ts: deck-overflow-queue-only field, valid solely on `fromModule: \"future\"` rows).", pos: "verb", conjugation: { class: "ichidan" } },
  ...
  { id: "hatachi", kana: "はたち", kanji: "二十歳", romaji: "hatachi", meaningEn: "20 years old", emoji: "🔞", fromModule: "m17", kind: "vocab", blocked: true, note: "age-20 milestone; Japanese coming-of-age — blocked because 🔞 is an age-restriction sign, not the age (m17's own ruling: every new atom there is imageable: false)", pos: "number" },
  ...
  { id: "yasumi", kana: "やすみ", kanji: "休み", romaji: "yasumi", meaningEn: "rest, vacation", emoji: "😴", fromModule: "m16", kind: "vocab", note: "sleeping face as rest proxy", pos: "noun" },
  ...
  { id: "ojiisan", kana: "おじいさん", kanji: "祖父", romaji: "ojiisan", meaningEn: "grandfather", emoji: "👴", fromModule: "m17", kind: "vocab", note: "older man; taught m17 Pack 9 (2026-09-10) as a generic elderly-man noun. kanji corrected 伯父/叔父 (uncle) → 祖父 (grandfather) to match the gloss — the old value was a mislabel", pos: "noun" },
  ...
  { id: "kyoudai", kana: "きょうだい", kanji: "兄弟", romaji: "kyoudai", meaningEn: "siblings", emoji: "👫", fromModule: "m17", kind: "vocab", blocked: true, note: "two people; siblings — blocked because 👫 reads as two friends, not siblings (m17 ships every new atom there imageable: false)", pos: "noun" },
  ...
  { id: "yaoya", kana: "やおや", kanji: "八百屋", romaji: "yaoya", meaningEn: "vegetable store", emoji: "🥬", fromModule: "future", freqRank: 143, kind: "vocab", note: "leafy greens stand-in for greengrocer", pos: "noun" },
  ...
  { id: "wakaru", kana: "わかる", kanji: "分かる", romaji: "wakaru", meaningEn: "to be understood", shortGloss: "to understand", emoji: "💡", fromModule: "future", freqRank: 149, kind: "vocab", blocked: true, note: "lightbulb already used for 電気; understanding too abstract. shortGloss uses the learner-facing sense so tiles sit consistently beside わからない 'don't understand' (m6 walk 2026-07-23). meaningEn keeps the literal passive/spontaneous sense ('to be understood') — matchTileGloss/display always prefer shortGloss so nothing user-facing changes, but m11's わかった 'understood (past)' derived gloss needs the literal substring 'understood' in the base for the gloss-mismatch check (fb16 gate fix 2026-09-15)", pos: "verb", conjugation: { class: "godan", entryId: "wakaru" } },
  ...
  { id: "too", kana: "とお", kanji: "十", romaji: "too", meaningEn: "ten", emoji: "🔟", fromModule: "m9", blocked: true, kind: "vocab", pos: "number", note: "re-homed m32→m9 (TestFlight #202/#204, 2026-09-18): m32-neo-5 declared it with zero supporting beat (Q11 orphan); now taught in m9-neo-3 next to the つ-counter series it stops. No introducedByLessonId set before or after this move (module-fallback unlock; checked no other lesson relied on the old m32 fallback — nothing else referenced this kana). no picture debut (inv-30 census 2026-08-20): じゅう's 🔟 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)" },
  ...
  { id: "gozen", kana: "ごぜん", kanji: "午前", romaji: "gozen", meaningEn: "A.M.", emoji: "🌅", fromModule: "m11", blocked: true, kind: "vocab", note: "sunrise; no picture debut (inv-30 census 2026-08-20): あさ's 🌅 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)", pos: "noun" },
  ...
  { id: "hanbun", kana: "はんぶん", kanji: "半分", romaji: "hanbun", meaningEn: "half", emoji: "🌗", fromModule: "future", freqRank: 157, kind: "vocab", note: "half symbol | swapped ½→🌗 (Noto has no fraction glyph; half-moon reads as 'half')", pos: "noun" },
  ...
  { id: "atsui-kind", kana: "あつい", kanji: "厚い", romaji: "atsui", meaningEn: "thick", fromModule: "future", freqRank: 160, kind: "vocab", blocked: true, note: "polysemous abstract adjective", pos: "adjective", conjugation: { class: "i-adj" } },
  ...
  { id: "kissaten", kana: "きっさてん", kanji: "喫茶店", romaji: "kissaten", meaningEn: "coffee shop", emoji: "☕", fromModule: "m13", kind: "vocab", note: "coffee cup; café", pos: "noun" },
  ...
  { id: "natsuyasumi", kana: "なつやすみ", kanji: "夏休み", romaji: "natsuyasumi", meaningEn: "summer vacation", emoji: "🏖️", fromModule: "m13", kind: "vocab", pos: "noun" },
  ...
  { id: "yoru", kana: "よる", kanji: "夜", romaji: "yoru", meaningEn: "night", emoji: "🌙", fromModule: "future", freqRank: 177, kind: "vocab", pos: "noun" },
  ...
  { id: "otona", kana: "おとな", kanji: "大人", romaji: "otona", meaningEn: "adult", emoji: "🧑", fromModule: "m17", kind: "vocab", blocked: true, note: "taught m17 Pack 9 (2026-09-10). blocked: 🧑 is ひと's (m1, live, unblocked) — m19/m24 shared-glyph ruling; m17 IR keeps it imageable:false, debuts on the dare/polite rule card instead", pos: "noun" },
  ...
  { id: "oozei", kana: "おおぜい", kanji: "大勢", romaji: "oozei", meaningEn: "many people", emoji: "👨‍👩‍👧‍👦", fromModule: "future", freqRank: 181, kind: "vocab", note: "family cluster = many people", pos: "noun" },
  { id: "daisuki", kana: "だいすき", kanji: "大好き", romaji: "daisuki", meaningEn: "love, really like", emoji: "😍", fromModule: "future", freqRank: 182, kind: "vocab", note: "heart as love cue", pos: "adjective", conjugation: { class: "na-adj" } },
  ...
  { id: "okusan", kana: "おくさん", kanji: "奥さん", romaji: "okusan", meaningEn: "wife", emoji: "👰", fromModule: "future", freqRank: 184, kind: "vocab", note: "bride stands in for wife", pos: "noun" },
  { id: "onna", kana: "おんな", kanji: "女", romaji: "onna", meaningEn: "woman", emoji: "👩", fromModule: "m17", kind: "vocab", blocked: true, note: "taught m17 Pack 9 (2026-09-10). blocked: 👩 is あね's (m17, live, already blocked) — m19/m24 shared-glyph ruling; m17 IR keeps it imageable:false, debuts on the dare/polite rule card instead", pos: "noun" },
  { id: "onnanoko", kana: "おんなのこ", kanji: "女の子", romaji: "onnanoko", meaningEn: "girl", emoji: "👧", fromModule: "m17", kind: "vocab", blocked: true, note: "taught m17 Pack 9 (2026-09-10). blocked: 👧 is いもうと's (m17, live, already blocked) — m19/m24 shared-glyph ruling; m17 IR keeps it imageable:false, debuts on the dare/polite rule card instead", pos: "noun" },
  { id: "suki", kana: "すき", kanji: "好き", romaji: "suki", meaningEn: "like", emoji: "💗", fromModule: "m13", kind: "vocab", blocked: true, note: "heart. fromModule re-homed m9 → m13 (2026-07-29, B067/B068): ja-m13-neo-7 introduces it — the legacy tag mismatched its live teaching module. blocked: the suki-kirai-no rule card IS the debut (m13 IR note), and ❤️ cannot cue 'likeable' against love-words", pos: "adjective", conjugation: { class: "na-adj", entryId: "suki" } },
  { id: "imouto", kana: "いもうと", kanji: "妹", romaji: "imouto", meaningEn: "younger sister", emoji: "👧", fromModule: "m17", blocked: true, kind: "vocab", note: "younger-girl approximation; sister relation context-dependent; no picture debut (inv-30 census 2026-08-20): named first by its own module's rule card, which compiles to a pinned step no debut MCQ can precede (m20/m21 card-steals-the-picture rule; netsu precedent)", pos: "noun" },
  ...
  { id: "sukoshi", kana: "すこし", kanji: "少し", romaji: "sukoshi", meaningEn: "a little", emoji: "🤏", fromModule: "future", freqRank: 192, kind: "vocab", note: "pinching hand as small-amount proxy", pos: "adverb" },
  { id: "sukunai", kana: "すくない", kanji: "少ない", romaji: "sukunai", meaningEn: "few", fromModule: "future", freqRank: 193, introducedByLessonId: "ja-m22-3-2", kind: "vocab", blocked: true, note: "abstract quantifier", pos: "noun" },
  { id: "iru-be", kana: "いる", romaji: "iru", meaningEn: "to be, to have (used for people and animals)", fromModule: "m6", introducedByLessonId: "ja-m11-4-1", kind: "vocab", blocked: true, note: "existence-of — rubric explicit block. No kanji on purpose: いる is written in kana in modern text; 居る is a dictionary spelling nobody teaches (TestFlight 2026-09-06 #37 flashcard front)", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "hidari", kana: "ひだり", kanji: "左", romaji: "hidari", meaningEn: "left", emoji: "👈", fromModule: "m32", kind: "vocab", pos: "noun" },
  ...
  { id: "niwa", kana: "にわ", kanji: "庭", romaji: "niwa", meaningEn: "garden", emoji: "🌳", fromModule: "m19", kind: "vocab", blocked: true, note: "tree as garden proxy; taught m19 Pack 8 (2026-09-10). blocked: 🌳 is き's (m18, live) — m19/m24 shared-glyph ruling; m19 IR keeps it imageable:false, debuts on the ni-location/around-town rule card instead", pos: "noun" },
  { id: "rouka", kana: "ろうか", kanji: "廊下", romaji: "rouka", meaningEn: "hallway", fromModule: "future", freqRank: 198, kind: "vocab", blocked: true, note: "no corridor emoji in Noto", pos: "noun" },
  { id: "tatemono", kana: "たてもの", kanji: "建物", romaji: "tatemono", meaningEn: "building", emoji: "🏢", fromModule: "m19", kind: "vocab", blocked: true, note: "taught m19 Pack 8 (2026-09-10). blocked: 🏢 is かいしゃ's (m7, live) — m19/m24 shared-glyph ruling; m19 IR keeps it imageable:false, debuts on the ni-location/around-town rule card instead", pos: "noun" },
  ...
  { id: "tsuyoi", kana: "つよい", kanji: "強い", romaji: "tsuyoi", meaningEn: "strong", emoji: "💪", fromModule: "m28", blocked: true, kind: "vocab", note: "flexed bicep; no picture debut (inv-30 census 2026-08-20): げんき's 💪 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)", pos: "adjective", conjugation: { class: "i-adj" } },
  ...
  { id: "isogashii", kana: "いそがしい", kanji: "忙しい", romaji: "isogashii", meaningEn: "busy", emoji: "😰", fromModule: "m15", kind: "vocab", note: "anxious sweat = busy/overwhelmed", pos: "adjective", conjugation: { class: "i-adj" } },
  ...
  { id: "tokoro", kana: "ところ", kanji: "所", romaji: "tokoro", meaningEn: "place", fromModule: "m46", introducedByLessonId: "ja-m46-neo-4", kind: "vocab", blocked: true, note: "abstract noun (per rubric: ところ explicitly flagged); cashed in m46 (tokoro-da-aspect lesson) — introducedByLessonId re-pointed off the dead archived ja-m9-1-2 pointer onto the live lesson that actually introduces it", pos: "noun" },
  { id: "te", kana: "て", kanji: "手", romaji: "te", meaningEn: "hand", emoji: "✋", fromModule: "m22", kind: "vocab", pos: "noun" },
  { id: "osu", kana: "おす", kanji: "押す", romaji: "osu", meaningEn: "to push", emoji: "👆", fromModule: "m32", kind: "vocab", blocked: true, note: "pointing/pushing finger; blocked — 👆 reads as まっすぐ's ⬆️ at thumbnail size, and まっすぐ is met one lesson earlier", pos: "verb", conjugation: { class: "godan" } },
  ...
  { id: "sanposuru", kana: "さんぽする", kanji: "散歩する", romaji: "sanposuru", meaningEn: "to take a walk", emoji: "🚶", fromModule: "future", freqRank: 208, kind: "vocab", pos: "verb", conjugation: { class: "irregular" } },
  ...
  { id: "eigakan", kana: "えいがかん", kanji: "映画館", romaji: "eigakan", meaningEn: "movie theater", emoji: "🎦", fromModule: "future", freqRank: 212, kind: "vocab", pos: "noun" },
  ...
  { id: "hirugohan", kana: "ひるごはん", kanji: "昼ご飯", romaji: "hirugohan", meaningEn: "lunch", emoji: "🍱", fromModule: "future", freqRank: 214, kind: "vocab", note: "bento reads as midday meal", pos: "noun" },
  ...
  { id: "kurai", kana: "くらい", kanji: "暗い", romaji: "kurai", meaningEn: "dark", emoji: "🌑", fromModule: "future", freqRank: 216, kind: "vocab", note: "new moon = dark", pos: "adjective", conjugation: { class: "i-adj" } },
  ...
  { id: "asagohan", kana: "あさごはん", kanji: "朝ご飯", romaji: "asagohan", meaningEn: "breakfast", emoji: "🍳", fromModule: "future", freqRank: 218, kind: "vocab", note: "fried egg — also used for 台所; mild collision", pos: "noun" },
  ...
  { id: "yoko", kana: "よこ", kanji: "横", romaji: "yoko", meaningEn: "side", emoji: "↔️", fromModule: "future", freqRank: 222, introducedByLessonId: "ja-m17-8-1", kind: "vocab", note: "horizontal arrow for side/width", pos: "noun" },
  ...
  { id: "tomaru", kana: "とまる", kanji: "止まる", romaji: "tomaru", meaningEn: "to stop", emoji: "🛑", fromModule: "m32", kind: "vocab", pos: "verb", conjugation: { class: "godan", entryId: "tomaru" } },
  ...
  { id: "youfuku", kana: "ようふく", kanji: "洋服", romaji: "youfuku", meaningEn: "clothing", emoji: "👔", fromModule: "future", freqRank: 234, kind: "vocab", note: "necktie/shirt", pos: "noun" },
  ...
  { id: "sentaku", kana: "せんたく", kanji: "洗濯", romaji: "sentaku", meaningEn: "laundry", emoji: "🧺", fromModule: "future", freqRank: 235, kind: "vocab", note: "laundry basket", pos: "noun" },
  ...
  { id: "suzushii", kana: "すずしい", kanji: "涼しい", romaji: "suzushii", meaningEn: "cool", emoji: "🍃", fromModule: "m25", kind: "vocab", note: "leaf in wind — cool/refreshing", pos: "adjective", conjugation: { class: "i-adj" } },
  ...
  { id: "seito", kana: "せいと", kanji: "生徒", romaji: "seito", meaningEn: "student", emoji: "🎒", fromModule: "m28", kind: "vocab", note: "backpack as pupil cue", pos: "noun" },
  ...
  { id: "machi", kana: "まち", kanji: "町", romaji: "machi", meaningEn: "town, city", emoji: "🏘️", fromModule: "m19", kind: "vocab", pos: "noun" },
  { id: "ryuugakusei", kana: "りゅうがくせい", kanji: "留学生", romaji: "ryuugakusei", meaningEn: "international student", emoji: "🎓", fromModule: "future", freqRank: 247, introducedByLessonId: "ja-m25-5-2", kind: "vocab", note: "graduation cap", pos: "noun" },
  ...
  { id: "migaku", kana: "みがく", kanji: "磨く", romaji: "migaku", meaningEn: "to polish", emoji: "🪥", fromModule: "m13", kind: "vocab", note: "toothbrush; taught by m13 vocab pack 2026-07-29 (B067); was m20. m13 spends the polish sense (くるま/とけい) — 歯 arrives with pack 6 (m16)", pos: "verb", conjugation: { class: "godan", entryId: "migaku" } },
  { id: "watakushi", kana: "わたくし", kanji: "私", romaji: "watakushi", meaningEn: "I, myself", fromModule: "future", freqRank: 255, introducedByLessonId: "ja-m19-3-2", kind: "vocab", blocked: true, note: "pronoun — rubric blocks pronouns", pos: "pronoun" },
  ...
  { id: "kekkou", kana: "けっこう", kanji: "結構", romaji: "kekkou", meaningEn: "fine, enough", fromModule: "m10", introducedByLessonId: "ja-m21-6-2", kind: "vocab", blocked: true, note: "polysemous abstract adjective/adverb", pos: "adjective", conjugation: { class: "na-adj" } },
  ...
  { id: "jidousha", kana: "じどうしゃ", kanji: "自動車", romaji: "jidousha", meaningEn: "car", emoji: "🚙", fromModule: "future", freqRank: 266, kind: "vocab", pos: "noun" },
  { id: "kabin", kana: "かびん", kanji: "花瓶", romaji: "kabin", meaningEn: "vase", emoji: "🏺", fromModule: "future", freqRank: 267, kind: "vocab", note: "amphora — closest Noto vase", pos: "noun" },
  ...
  { id: "eigo", kana: "えいご", kanji: "英語", romaji: "eigo", meaningEn: "English", emoji: "🇺🇸", fromModule: "m26", blocked: true, kind: "vocab", note: "US flag — wired via separate flag dir; no picture debut (inv-30 census 2026-08-20): アメリカ's 🇺🇸 owns the glyph (m19/m24 ruling: a debut distractor the picture names equally well)", pos: "noun" },
  ...
  { id: "oboeru", kana: "おぼえる", kanji: "覚える", romaji: "oboeru", meaningEn: "to memorize, to learn", emoji: "🧠", fromModule: "m11", kind: "vocab", note: "brain; taught by m11 vocab pack 2026-07-29 (B067); was m29 with dangling ja-m29-2-1 attribution — left unset so the lessonAtomIndex fallback attributes it", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "kado", kana: "かど", kanji: "角", romaji: "kado", meaningEn: "corner", emoji: "📐", fromModule: "m32", kind: "vocab", note: "triangle ruler — corner/angle", pos: "noun" },
  ...
  { id: "kotoba", kana: "ことば", kanji: "言葉", romaji: "kotoba", meaningEn: "word", emoji: "🔤", fromModule: "m26", kind: "vocab", note: "ABC input symbol as language proxy", pos: "noun" },
  ...
  { id: "haru-stick", kana: "はる", kanji: "貼る", romaji: "haru", meaningEn: "to stick", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no concrete Noto referent; pair with phrase — re-stamped future → m41; old ja-m14-6-2 attribution was DEAD (exists only in curriculum/_archive/m14.ts, not the live mockLessons registry) so repointed to this module's own first live debut lesson. `freqRank` dropped on landing (frequencyAtoms.test.ts: deck-overflow-queue-only field, valid solely on `fromModule: \"future\"` rows).", pos: "verb", conjugation: { class: "godan" } },
  ...
  { id: "chigau", kana: "ちがう", kanji: "違う", romaji: "chigau", meaningEn: "to be different", emoji: "❌", fromModule: "m10", kind: "vocab", note: "X as 'wrong/different' proxy", pos: "verb", conjugation: { class: "godan" } },
  ...
  { id: "oriru", kana: "おりる", kanji: "降りる", romaji: "oriru", meaningEn: "to get off", emoji: "⬇️", fromModule: "m19", kind: "vocab", note: "down-arrow = descend; taught m19 Pack 8 (2026-09-10), pack 7 leftover", pos: "verb", conjugation: { class: "ichidan", entryId: "oriru" } },
  ...
  { id: "kaidan", kana: "かいだん", kanji: "階段", romaji: "kaidan", meaningEn: "stairs", emoji: "🪜", fromModule: "m19", kind: "vocab", note: "ladder; closest Noto for stairs; taught m19 Pack 8 (2026-09-10)", pos: "noun" },
  { id: "tonari", kana: "となり", kanji: "隣", romaji: "tonari", meaningEn: "next door", fromModule: "future", freqRank: 288, kind: "vocab", blocked: true, note: "spatial relation; no visual referent", pos: "noun" },
  ...
  { id: "hikouki", kana: "ひこうき", kanji: "飛行機", romaji: "hikouki", meaningEn: "airplane", emoji: "✈️", fromModule: "m23", kind: "vocab", blocked: true, note: "blocked because ✈️ is already りょこう's emoji and りょこう is a met word — m23's ruling", pos: "noun" },
];
...
const JA_COURSE_ATOMS_PART2: readonly CourseAtom[] = [
  ...
  { id: "naku", kana: "なく", kanji: "鳴く", romaji: "naku", meaningEn: "to cry (animal)", emoji: "🐦", fromModule: "future", freqRank: 297, kind: "vocab", note: "bird as canonical chirper", pos: "verb" },
  ...
  { id: "zettai", kana: "ぜったい", kanji: "絶対", romaji: "zettai", meaningEn: "absolutely", fromModule: "m43", introducedByLessonId: "ja-m43-neo-2", kind: "vocab", blocked: true, note: "modal adverb — was a thr-n4 glue-adverb drip stub with no introducedByLessonId; m43 cashes it in, same reuse discipline as m41's ならぶ/ならべる and m42's p-tte (docs/ja-m43-brief-2026-09-10.md §1)", pos: "adverb" },
  ...
  { id: "nande", kana: "なんで", kanji: "何で", romaji: "nande", meaningEn: "why", fromModule: "future", freqRank: 305, kind: "vocab", blocked: true, note: "casual interrogative", pos: "adverb" },
  { id: "doushitano", kana: "どうしたの", romaji: "doushitano", meaningEn: "what's wrong?, what's the matter?", shortGloss: "what's wrong?", fromModule: "m44", introducedByLessonId: "ja-m44-neo-2", kind: "phrase", blocked: true, note: "was a thr-n4/future-backlog sentinel row (freqRank 306, unowned) — m44's own dialogue-opener debut cashes it in, same reuse discipline as m43's ぜったい (see block comment above); casual function phrase, no honest single-frame picture", pos: "expression" },
  ...
  { id: "nakama", kana: "なかま", kanji: "仲間", romaji: "nakama", meaningEn: "friend, companion", emoji: "👥", fromModule: "future", freqRank: 309, kind: "vocab", pos: "noun" },
  ...
  { id: "ore", kana: "おれ", kanji: "俺", romaji: "ore", meaningEn: "I", fromModule: "m10", kind: "vocab", blocked: true, note: "recognition only — production register is m47's call (plan §3.2); registered so it can exist as a flashcard at all", pos: "pronoun" },
  { id: "p-nagara", kana: "ながら", romaji: "nagara", meaningEn: "while doing (simultaneous action)", fromModule: "m36", kind: "particle", pos: "particle" },
  { id: "p-tte", kana: "って", romaji: "tte", meaningEn: "quotative (= と)", fromModule: "m42", introducedByLessonId: "ja-m42-neo-3", kind: "particle", note: "bound-morpheme hazard (inv 41): って is a substring of every whole-registered て-form with a geminate (いって/かって/まって/しって…) — those atoms win longest-match, and the whole-course tile diff at registration was clean. Re-run the tile diff if a new 〜って form ships un-atomized. CASHED IN at m42 (tte-quotative) — this stub carried fromModule: m18 as a placeholder since registration with never-live content; m42 is its first genuine teaching debut.", pos: "particle" },
  // ── m7-neo (spine tile s07) — the polite layer: ます / ません / です ──
  { id: "shimasu", kana: "します", romaji: "shimasu", meaningEn: "do", fromModule: "m7", introducedByLessonId: "ja-m7-neo-2", kind: "vocab", pos: "verb" },
  { id: "kimasu", kana: "きます", romaji: "kimasu", meaningEn: "come", fromModule: "m7", introducedByLessonId: "ja-m7-neo-2", kind: "vocab", pos: "verb" },
  { id: "kaimasu", kana: "かいます", romaji: "kaimasu", meaningEn: "buy", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "kikimasu", kana: "ききます", romaji: "kikimasu", meaningEn: "listen, ask", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "asobimasu", kana: "あそびます", romaji: "asobimasu", meaningEn: "play", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "tabemasen", kana: "たべません", romaji: "tabemasen", meaningEn: "don't eat", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "nomimasen", kana: "のみません", romaji: "nomimasen", meaningEn: "don't drink", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "mimasen", kana: "みません", romaji: "mimasen", meaningEn: "don't watch", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "ikimasen", kana: "いきません", romaji: "ikimasen", meaningEn: "don't go", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "kimasen", kana: "きません", romaji: "kimasen", meaningEn: "doesn't come", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "shimasen", kana: "しません", romaji: "shimasen", meaningEn: "don't do", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "hatarakimasen", kana: "はたらきません", romaji: "hatarakimasen", meaningEn: "don't work", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "arimasen", kana: "ありません", romaji: "arimasen", meaningEn: "doesn't have, isn't there", fromModule: "m7", introducedByLessonId: "ja-m7-neo-1", kind: "vocab", pos: "verb" },
  { id: "hatarakimasu", kana: "はたらきます", romaji: "hatarakimasu", meaningEn: "work", fromModule: "m7", introducedByLessonId: "ja-m7-neo-7", kind: "vocab", pos: "verb" },
  ...
  { id: "shokuji", kana: "しょくじ", romaji: "shokuji", meaningEn: "meal", fromModule: "m8", introducedByLessonId: "ja-m8-neo-5", kind: "vocab", pos: "noun" },
  ...
  { id: "uun", kana: "ううん", romaji: "uun", meaningEn: "nope", shortGloss: "nope", fromModule: "m10", introducedByLessonId: "ja-m10-neo-2", kind: "vocab", pos: "interjection" },
  ...
  { id: "boku", kana: "ぼく", romaji: "boku", meaningEn: "I, me", shortGloss: "I", fromModule: "m10", introducedByLessonId: "ja-m10-neo-6", kind: "vocab", pos: "pronoun" },
  { id: "shirimasu", kana: "しります", romaji: "shirimasu", meaningEn: "know", fromModule: "m10", introducedByLessonId: "ja-m10-neo-1", kind: "vocab", pos: "verb" },
  { id: "shirimasen", kana: "しりません", romaji: "shirimasen", meaningEn: "don't know", fromModule: "m10", introducedByLessonId: "ja-m10-neo-1", kind: "vocab", pos: "verb" },
  { id: "wakarimasu", kana: "わかります", romaji: "wakarimasu", meaningEn: "understand", fromModule: "m10", introducedByLessonId: "ja-m10-neo-1", kind: "vocab", pos: "verb" },
  { id: "chigaimasu", kana: "ちがいます", romaji: "chigaimasu", meaningEn: "that's not right", fromModule: "m10", introducedByLessonId: "ja-m10-neo-1", kind: "vocab", pos: "verb" },
  ...
  // Copula past
  { id: "datta", kana: "だった", romaji: "datta", meaningEn: "was, were", shortGloss: "was (plain)", fromModule: "m11", introducedByLessonId: "ja-m11-neo-6", kind: "vocab", blocked: true, note: "copula — no concrete referent", pos: "verb" },
  { id: "deshita", kana: "でした", romaji: "deshita", meaningEn: "was, were", shortGloss: "was", fromModule: "m11", introducedByLessonId: "ja-m11-neo-8", kind: "vocab", blocked: true, note: "copula — no concrete referent", pos: "verb" },
  ...
  { id: "node", kana: "ので", romaji: "node", meaningEn: "because", shortGloss: "because", fromModule: "m16", introducedByLessonId: "ja-m16-neo-3", kind: "vocab", blocked: true, note: "conjunctive particle — no concrete referent", pos: "particle" },
  ...
  { id: "mireru", kana: "みれる", romaji: "mireru", meaningEn: "can watch (ら-dropped form)", shortGloss: "can watch", fromModule: "m24", introducedByLessonId: "ja-m24-neo-2", kind: "vocab", blocked: true, note: "ら抜き variant. See たべれる — `blocked` is not-imageable only; the production ban lives in m24-neo.test.ts. SRS-eligible on purpose.", pos: "verb" },
  ...
  { id: "kikoeru", kana: "きこえる", romaji: "kikoeru", meaningEn: "to be heard, to reach the ear", shortGloss: "is audible", fromModule: "m24", introducedByLessonId: "ja-m24-neo-6", kind: "vocab", blocked: true, note: "a state of the world, not an action — 👂 is みみ's and きく's", pos: "verb", conjugation: { class: "ichidan" } },
  ...
  { id: "mashou", kana: "ましょう", romaji: "mashou", meaningEn: "let's ~", shortGloss: "let's ~", fromModule: "m24", introducedByLessonId: "ja-m24-neo-10", kind: "vocab", blocked: true, note: "bound suffix — no referent a picture could name", pos: "expression" },
  ...
  { id: "darou", kana: "だろう", romaji: "darou", meaningEn: "probably", shortGloss: "probably (plain)", fromModule: "m25", introducedByLessonId: "ja-m25-neo-9", kind: "vocab", blocked: true, note: "recognition only — sentence-final だろう to a listener is blunt/masculine (spine n13)", pos: "expression" },
  ...
  { id: "kekka", kana: "けっか", romaji: "kekka", meaningEn: "result", shortGloss: "result", fromModule: "m30", kind: "vocab", blocked: true, pos: "noun" },
  { id: "yoyaku", kana: "よやく", romaji: "yoyaku", meaningEn: "booking, reservation", shortGloss: "booking", fromModule: "m30", kind: "vocab", blocked: true, pos: "noun" },
  ...
  { id: "setsumei", kana: "せつめい", romaji: "setsumei", meaningEn: "explanation", shortGloss: "explanation", fromModule: "m30", kind: "vocab", blocked: true, pos: "noun" },
  { id: "kotae", kana: "こたえ", romaji: "kotae", meaningEn: "answer", shortGloss: "answer", fromModule: "m30", kind: "vocab", blocked: true, note: "longest-match keeps こたえる (4) ahead of こたえ (3), so the verb still tiles whole", pos: "noun" },
  ...
  { id: "gengo", kana: "げんご", romaji: "gengo", meaningEn: "language", shortGloss: "language", fromModule: "m30", kind: "vocab", blocked: true, note: "abstract noun — no honest emoji distinct from にほん/アメリカ's flags (the えいご class)", pos: "noun" },
  { id: "nihongo", kana: "にほんご", romaji: "nihongo", meaningEn: "Japanese language", shortGloss: "Japanese", fromModule: "m30", kind: "vocab", blocked: true, note: "same flag-collision reasoning as げんご; distinct atom from にほん (Japan, m4) and にほんじん (Japanese person, m3) — registered WHOLE so longest-match keeps it ahead of にほん", pos: "noun" },
  ...
  { id: "kudasaru", kana: "くださる", romaji: "kudasaru", meaningEn: "to give me", shortGloss: "give me (hon.)", fromModule: "m31", kind: "vocab", blocked: true, note: "RECOGNITION ONLY in the spine — see the production-direction question in the issue doc, the same open question as m24's ら抜き", pos: "verb", conjugation: { class: "godan" } },
  { id: "itadaku", kana: "いただく", romaji: "itadaku", meaningEn: "to receive", shortGloss: "receive (hon.)", fromModule: "m31", kind: "vocab", blocked: true, note: "RECOGNITION ONLY in the spine — see the issue doc", pos: "verb", conjugation: { class: "godan" } },
  { id: "yorokobu", kana: "よろこぶ", romaji: "yorokobu", meaningEn: "to be happy", shortGloss: "be delighted", fromModule: "m31", kind: "vocab", blocked: true, pos: "verb", conjugation: { class: "godan" } },
  { id: "purezento", kana: "プレゼント", romaji: "purezento", meaningEn: "present", shortGloss: "present", fromModule: "m31", kind: "vocab", blocked: true, note: "blocked per the IR — 🎁 already belongs to あげる", pos: "noun" },
  { id: "keeki", kana: "ケーキ", romaji: "keeki", meaningEn: "cake", shortGloss: "cake", fromModule: "m31", kind: "vocab", blocked: true, note: "blocked per the IR — 🍰 collides with おかし's 🍬 family", pos: "noun" },
  { id: "hanataba", kana: "はなたば", romaji: "hanataba", meaningEn: "bouquet", shortGloss: "bouquet", fromModule: "m31", kind: "vocab", blocked: true, note: "blocked — 💐 reads as はな, which is MET", pos: "noun" },
  ...
  { id: "kaado", kana: "カード", romaji: "kaado", meaningEn: "card", shortGloss: "card", fromModule: "m31", kind: "vocab", blocked: true, pos: "noun" },
  { id: "omiyage", kana: "おみやげ", romaji: "omiyage", meaningEn: "souvenir", shortGloss: "souvenir", fromModule: "m31", kind: "vocab", blocked: true, pos: "noun" },
  ...
  { id: "oiwai", kana: "おいわい", romaji: "oiwai", meaningEn: "celebration, congratulatory gift", shortGloss: "celebration", fromModule: "m31", kind: "vocab", blocked: true, pos: "noun" },
  { id: "kinen", kana: "きねん", romaji: "kinen", meaningEn: "commemoration, keepsake", shortGloss: "keepsake", fromModule: "m31", kind: "vocab", blocked: true, pos: "noun" },
  ...
  { id: "kikai", kana: "きかい", kanji: "機械", romaji: "kikai", meaningEn: "machine", shortGloss: "machine", emoji: "\u{1f916}", fromModule: "m32", kind: "vocab", pos: "noun" },
  { id: "oto", kana: "おと", kanji: "音", romaji: "oto", meaningEn: "sound", shortGloss: "sound", emoji: "\u{1f50a}", fromModule: "m32", kind: "vocab", pos: "noun" },
  { id: "chikamichi", kana: "ちかみち", kanji: "近道", romaji: "chikamichi", meaningEn: "shortcut", shortGloss: "shortcut", emoji: "\u{1f500}", fromModule: "m32", kind: "vocab", note: "diverging arrows \u2014 a route that leaves the main road and rejoins it", pos: "noun" },
  ...
  { id: "kaigi", kana: "かいぎ", kanji: "会議", romaji: "kaigi", meaningEn: "meeting", shortGloss: "meeting", emoji: "\u{1f4cb}", fromModule: "m33", kind: "vocab", note: "clipboard — an agenda, the one thing a meeting always has", pos: "noun" },
  { id: "hikidashi", kana: "ひきだし", kanji: "引き出し", romaji: "hikidashi", meaningEn: "drawer", shortGloss: "drawer", emoji: "\u{1f5c4}\ufe0f", fromModule: "m33", kind: "vocab", note: "file cabinet — the m33 carrier noun: a drawer opens, shuts, and has things put in and taken out of it, so one word carries four of the nine pairs", pos: "noun" },
  ...
  { id: "yume", kana: "ゆめ", kanji: "夢", romaji: "yume", meaningEn: "dream — asleep, or for the future", shortGloss: "dream", fromModule: "m34", kind: "vocab", blocked: true, note: "abstract — a sleeping face reads 'asleep', not 'dream' or 'a future goal'", pos: "noun" },
  { id: "yotei", kana: "よてい", kanji: "予定", romaji: "yotei", meaningEn: "plan, schedule", shortGloss: "plan", fromModule: "m34", kind: "vocab", blocked: true, note: "blocked: 📅 already belongs to きょう, and a calendar can't distinguish 'plan' from 'calendar' itself", pos: "noun" },
  ...
  { id: "mokuhyou", kana: "もくひょう", kanji: "目標", romaji: "mokuhyou", meaningEn: "goal, target", shortGloss: "goal", emoji: "🎯", fromModule: "m34", kind: "vocab", note: "bullseye — honest per なか's own blocked note: 🎯 reads 'target/goal', not 'middle'", pos: "noun" },
  { id: "chokin", kana: "ちょきん", kanji: "貯金", romaji: "chokin", meaningEn: "savings", shortGloss: "savings", fromModule: "m34", kind: "vocab", blocked: true, note: "blocked: 💰 already belongs to おかね, and a pile of coins can't distinguish 'savings' from money itself", pos: "noun" },
  ...
  { id: "onegai", kana: "おねがい", romaji: "onegai", meaningEn: "favor, request", shortGloss: "favor", fromModule: "m35", introducedByLessonId: "ja-m35-neo-5", kind: "vocab", blocked: true, note: "abstract — a favor/request has no honest referent; 🙏 reads 'pray/thanks', not 'a request'", pos: "noun" },
  { id: "mukae", kana: "むかえ", romaji: "mukae", meaningEn: "pick-up — going to meet someone (むかえに いく)", shortGloss: "pick-up", fromModule: "m35", introducedByLessonId: "ja-m35-neo-9", kind: "vocab", blocked: true, note: "abstract — 'going to meet someone' collapses into あう's 🤝 with nothing left to distinguish 'pick-up' from 'meeting'", pos: "noun" },
  ...
  { id: "hatsumei", kana: "はつめい", kanji: "発明", romaji: "hatsumei", meaningEn: "invention", shortGloss: "invention", fromModule: "m40", introducedByLessonId: "ja-m40-neo-5", kind: "vocab", blocked: true, note: "abstract event noun; no honest single-frame picture. Suru-noun — conjugates as irregular (はつめいされる/はつめいされた)", pos: "noun" },
  ...
  { id: "kabe", kana: "かべ", kanji: "壁", romaji: "kabe", meaningEn: "wall", shortGloss: "wall", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no vendored SVG at this wiring stage — debut via ga-existence build beat, not word_image_mcq", pos: "noun" },
  { id: "tana", kana: "たな", kanji: "棚", romaji: "tana", meaningEn: "shelf", shortGloss: "shelf", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no vendored SVG at this wiring stage — debut via ga-existence build beat", pos: "noun" },
  { id: "posutaa", kana: "ポスター", romaji: "posutaa", meaningEn: "poster", shortGloss: "poster", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no vendored SVG at this wiring stage — debut via ga-existence build beat", pos: "noun" },
  { id: "memo", kana: "メモ", romaji: "memo", meaningEn: "memo, note", shortGloss: "memo", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "no vendored SVG at this wiring stage — debut via ga-existence build beat", pos: "noun" },
  { id: "kazaru", kana: "かざる", kanji: "飾る", romaji: "kazaru", meaningEn: "to decorate, to display", shortGloss: "decorate", fromModule: "m41", introducedByLessonId: "ja-m41-neo-1", kind: "vocab", blocked: true, note: "abstract action verb; no honest single-frame picture. Godan despite the -る ending (exception class, same shape as しかる/かえる/はいる/きる) — a-stem かざら, て-form かざって", pos: "verb", conjugation: { class: "godan" } },
  { id: "jishin", kana: "じしん", kanji: "地震", romaji: "jishin", meaningEn: "earthquake", shortGloss: "earthquake", fromModule: "m42", introducedByLessonId: "ja-m42-neo-1", kind: "vocab", blocked: true, note: "abstract event noun; no honest single-frame picture", pos: "noun" },
  { id: "taifuu", kana: "たいふう", kanji: "台風", romaji: "taifuu", meaningEn: "typhoon", shortGloss: "typhoon", fromModule: "m42", introducedByLessonId: "ja-m42-neo-1", kind: "vocab", blocked: true, note: "abstract weather event noun; no honest single-frame picture", pos: "noun" },
  { id: "jiko", kana: "じこ", kanji: "事故", romaji: "jiko", meaningEn: "accident", shortGloss: "accident", fromModule: "m42", introducedByLessonId: "ja-m42-neo-1", kind: "vocab", blocked: true, note: "abstract event noun; no honest single-frame picture", pos: "noun" },
  { id: "souda", kana: "そうだ", romaji: "souda", meaningEn: "I heard that ~, it's said that ~ (hearsay)", shortGloss: "I heard that ~", fromModule: "m42", introducedByLessonId: "ja-m42-neo-2", kind: "vocab", blocked: true, note: "copula-family hearsay auxiliary — no concrete referent, mirrors だった/でした's registration template. Attaches to a full plain-form clause via ordinary longest-match tokenizing, the same compositional mechanism as m41's あけてある — zero dedicated fusion-point atom needed per host sentence. Distinct kana string from m3's bare そう (agreement interjection) — no map-construction collision.", pos: "verb" },
  { id: "bangumi", kana: "ばんぐみ", kanji: "番組", romaji: "bangumi", meaningEn: "TV program, show", shortGloss: "TV program", fromModule: "m42", introducedByLessonId: "ja-m42-neo-2", kind: "vocab", blocked: true, note: "abstract media noun; no honest single-frame picture", pos: "noun" },
  { id: "kiji", kana: "きじ", kanji: "記事", romaji: "kiji", meaningEn: "article (news)", shortGloss: "article", fromModule: "m42", introducedByLessonId: "ja-m42-neo-2", kind: "vocab", blocked: true, note: "abstract media noun; no honest single-frame picture", pos: "noun" },
  { id: "uwasa", kana: "うわさ", kanji: "噂", romaji: "uwasa", meaningEn: "rumor", shortGloss: "rumor", fromModule: "m42", introducedByLessonId: "ja-m42-neo-3", kind: "vocab", blocked: true, note: "abstract noun; no honest single-frame picture. Below top-3000 frequency but kept — semantically load-bearing hearsay-domain carrier (うわさに きいた)", pos: "noun" },
  { id: "kisha", kana: "きしゃ", kanji: "記者", romaji: "kisha", meaningEn: "reporter, journalist", shortGloss: "reporter", fromModule: "m42", introducedByLessonId: "ja-m42-neo-3", kind: "vocab", blocked: true, note: "no vendored SVG at this wiring stage — debut via build beat, not word_image_mcq", pos: "noun" },
  { id: "itteita", kana: "いっていた", kanji: "言っていた", romaji: "itteita", meaningEn: "was saying, said (that ~)", shortGloss: "was saying", fromModule: "m42", introducedByLessonId: "ja-m42-neo-4", kind: "vocab", blocked: true, note: "fused multi-word carrier atom (word-level ownership, carrier-atom doctrine) for 言っていた — NOT decomposed into bare いって/いった for 言う, which would collide at atom-map construction with the LIVE m8 て-form いって (id itte, 行く) and m11 past いった (id itta-iku, 行く) — the m18 いった homograph ruling m21's ittari row already names. Attaches after a と-closed plain clause via ordinary longest-match tokenizing, zero fusion-point atom needed.", pos: "verb" },
  { id: "tsutaeru", kana: "つたえる", kanji: "伝える", romaji: "tsutaeru", meaningEn: "to convey, to tell (information) to someone", shortGloss: "to convey", fromModule: "m42", introducedByLessonId: "ja-m42-neo-4", kind: "vocab", blocked: true, note: "abstract communication verb; no honest single-frame picture. Ichidan — drops る before an ending (つたえ+られる)", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "shiraseru", kana: "しらせる", kanji: "知らせる", romaji: "shiraseru", meaningEn: "to inform, to let (someone) know", shortGloss: "to let know", fromModule: "m42", introducedByLessonId: "ja-m42-neo-4", kind: "vocab", blocked: true, note: "abstract communication verb; no honest single-frame picture. Ichidan — drops る before an ending (しらせ+られる)", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "housou", kana: "ほうそう", kanji: "放送", romaji: "housou", meaningEn: "broadcast", shortGloss: "broadcast", fromModule: "m42", introducedByLessonId: "ja-m42-neo-5", kind: "vocab", blocked: true, note: "abstract media noun; no honest single-frame picture", pos: "noun" },
  { id: "happyou", kana: "はっぴょう", kanji: "発表", romaji: "happyou", meaningEn: "announcement", shortGloss: "announcement", fromModule: "m42", introducedByLessonId: "ja-m42-neo-5", kind: "vocab", blocked: true, note: "abstract event noun; no honest single-frame picture", pos: "noun" },
  { id: "rashii", kana: "らしい", romaji: "rashii", meaningEn: "apparently, it seems (hearsay/evidential)", shortGloss: "apparently", fromModule: "m42", introducedByLessonId: "ja-m42-neo-6", kind: "vocab", blocked: true, note: "genuine free-standing i-adjective lemma, mirrors おいしい's registration template — glues to any known plain-form host via ordinary longest-match tokenizing, zero per-sentence derived atoms, same mechanism as って. Kept in bare non-past form throughout this module (no conjugated らしかった sentences authored) — the conjugation engine handles future conjugated forms automatically via this class link.", pos: "adjective", conjugation: { class: "i-adj" } },
  // ══ m43 — Certainty ladder: 〜かもしれない / 〜はず / でしょう-deepen (n4-14) ══
  { id: "yakusoku", kana: "やくそく", kanji: "約束", romaji: "yakusoku", meaningEn: "promise", shortGloss: "promise", fromModule: "m43", introducedByLessonId: "ja-m43-neo-1", kind: "vocab", blocked: true, note: "abstract social-commitment noun; no honest single-frame picture", pos: "noun" },
  { id: "tashika", kana: "たしか", kanji: "確か", romaji: "tashika", meaningEn: "for sure, if I recall correctly", shortGloss: "for sure", fromModule: "m43", introducedByLessonId: "ja-m43-neo-1", kind: "vocab", blocked: true, note: "sentence adverb of confidence — no referent a picture could name. Shares its kanji root (確) with the unregistered verb たしかめる 'to confirm/check' — no current collision (たしかめる has no courseAtoms row), but a future derivedFrom chain for that verb must NOT point at this id; different parts of speech sharing a root, not a conjugation pair (brief §1)", pos: "adverb" },
  { id: "kanarazu", kana: "かならず", kanji: "必ず", romaji: "kanarazu", meaningEn: "certainly, without fail", shortGloss: "without fail", fromModule: "m43", introducedByLessonId: "ja-m43-neo-1", kind: "vocab", blocked: true, note: "modal adverb of certainty about one's OWN action/resolve — no referent a picture could name. Checked against existing から (kara-because): かならず's own 5-kana string wins any greedy tokenizer match at its own position, no truncation risk", pos: "adverb" },
  { id: "moshikashitara", kana: "もしかしたら", romaji: "moshikashitara", meaningEn: "perhaps, possibly", shortGloss: "perhaps", fromModule: "m43", introducedByLessonId: "ja-m43-neo-2", kind: "vocab", blocked: true, note: "fixed sentence-opening adverb pairing with かもしれない — registered as ONE 7-kana lemma, not decomposed from m37's shorter もし (id moshi, conditional 'if'); longest-match tokenizing picks this full string over the shorter もし at the same position, checked clear (brief §1)", pos: "adverb" },
  { id: "kamoshirenai", kana: "かもしれない", romaji: "kamoshirenai", meaningEn: "might be, may be (epistemic possibility)", shortGloss: "might be", fromModule: "m43", introducedByLessonId: "ja-m43-neo-2", kind: "vocab", blocked: true, note: "bound sentence-ender — no referent a picture could name, mirrors でしょう/だろう's registration template. Registered as ONE fused 6-kana lemma so the casual truncation かも, when it appears bare at a sentence end, decomposes tokenizer-side into the two pre-existing free particles か (p-ka, m3) + も (p-mo, m3) rather than needing its own atom row — firm rule, never register かも as its own lemma (brief §3/§5/§6, inv 41 bound-morpheme class)", pos: "expression" },
  { id: "seikou", kana: "せいこう", kanji: "成功", romaji: "seikou", meaningEn: "success", shortGloss: "success", fromModule: "m43", introducedByLessonId: "ja-m43-neo-3", kind: "vocab", blocked: true, note: "abstract outcome noun; no honest single-frame picture. Composes with the already-known する (id suru, m11) for せいこうする 'to succeed', non-past forms only", pos: "noun" },
  { id: "shippai", kana: "しっぱい", kanji: "失敗", romaji: "shippai", meaningEn: "failure", shortGloss: "failure", fromModule: "m43", introducedByLessonId: "ja-m43-neo-3", kind: "vocab", blocked: true, note: "abstract outcome noun; no honest single-frame picture. Composes with the already-known する (id suru, m11) for しっぱいする 'to fail', non-past forms only", pos: "noun" },
  { id: "yosou", kana: "よそう", kanji: "予想", romaji: "yosou", meaningEn: "prediction, forecast", shortGloss: "prediction", fromModule: "m43", introducedByLessonId: "ja-m43-neo-4", kind: "vocab", blocked: true, note: "abstract cognition noun; no honest single-frame picture", pos: "noun" },
  { id: "hazu", kana: "はず", romaji: "hazu", meaningEn: "should be, expected to be (from evidence)", shortGloss: "should be", fromModule: "m43", introducedByLessonId: "ja-m43-neo-4", kind: "vocab", blocked: true, note: "formal expectation noun, mirrors こと/つもり's registration template — no concrete referent. Checked against existing はずかしい (embarrassed, i-adj): neither is a prefix of the other beyond the shared は-ず, no sentence in this module continues bare はず with かしい, no greedy-match risk (brief §1)", pos: "noun" },
  { id: "utagau", kana: "うたがう", kanji: "疑う", romaji: "utagau", meaningEn: "to doubt", shortGloss: "to doubt", fromModule: "m43", introducedByLessonId: "ja-m43-neo-5", kind: "vocab", blocked: true, note: "abstract cognition verb; no honest single-frame picture. Godan — a-stem うたがわ, て-form うたがって. Kept in bare dictionary form throughout this module (no conjugated past/negative sentences authored, sidesteps STEMS' narrow auto-derivation scope for IR-only verbs)", pos: "verb", conjugation: { class: "godan" } },
  { id: "shinjiru", kana: "しんじる", kanji: "信じる", romaji: "shinjiru", meaningEn: "to believe", shortGloss: "to believe", fromModule: "m43", introducedByLessonId: "ja-m43-neo-5", kind: "vocab", blocked: true, note: "abstract cognition verb; no honest single-frame picture. Ichidan — drops る before an ending (しんじ+られる). Kept in bare dictionary form throughout this module, same sidestep as うたがう above", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "anshin", kana: "あんしん", kanji: "安心", romaji: "anshin", meaningEn: "peace of mind, relief", shortGloss: "relief", fromModule: "m43", introducedByLessonId: "ja-m43-neo-6", kind: "vocab", blocked: true, note: "na-adjective/noun of psychological state; no honest single-frame picture (the げんき/しんせつ/ふべん class). Distinct kana string from あんぜん (id anzen, m36, 'safe/safety' — an objective property of a place); semantically adjacent in a rushed gloss but no atomIndex() collision, disambiguated by collocation — あんしんする as a felt state vs あんぜん(な) as an objective property (brief §1)", pos: "adjective", conjugation: { class: "na-adj" } },
  { id: "shinpai", kana: "しんぱい", kanji: "心配", romaji: "shinpai", meaningEn: "worry, anxiety", shortGloss: "worry", fromModule: "m43", introducedByLessonId: "ja-m43-neo-6", kind: "vocab", blocked: true, note: "na-adjective/noun of psychological state; no honest single-frame picture. Composes with the already-known する (id suru, m11) for しんぱいする 'to worry', non-past forms only", pos: "adjective", conjugation: { class: "na-adj" } },
  { id: "nichigainai", kana: "にちがいない", romaji: "nichigainai", meaningEn: "must be, no doubt (strong certainty — recognition only)", shortGloss: "must be", fromModule: "m43", introducedByLessonId: "ja-m43-neo-6", kind: "vocab", blocked: true, note: "bound sentence-ender — no referent a picture could name, mirrors だろう's registration template. RECOGNITION ONLY (spine §1.3, §0): never a graded build/cloze/production target anywhere in this module — cited only in neo-6's recognition aside and neo-8's certainty-ladder synthesis card, matching だろう's own recognition-only precedent exactly", pos: "expression" },
  // ── m44 (spine n4-15) — evidential-family reassembly: ようだ / みたい /
  // のように・のような. All rows blocked:true, the same all-blocked
  // accommodation every m11+ IR module uses (the modern compiler's own
  // `imageable:` flag on the IR newAtom, not this file's `blocked` field,
  // drives word_image_mcq emission — see the paatii/m41 row's note above).
  { id: "nioi", kana: "におい", romaji: "nioi", meaningEn: "smell", shortGloss: "smell", fromModule: "m44", introducedByLessonId: "ja-m44-neo-1", kind: "vocab", blocked: true, note: "abstract sensory noun; no honest single-frame picture. Kanji 匂い withheld — this module keeps its four sensory-domain nouns (におい/あじ/けむり/こおり) at kana-only register, matching the brief's structure-true-gloss discipline for evidence words", pos: "noun" },
  { id: "aji", kana: "あじ", kanji: "味", romaji: "aji", meaningEn: "taste, flavor", shortGloss: "taste", fromModule: "m44", introducedByLessonId: "ja-m44-neo-1", kind: "vocab", blocked: true, note: "abstract sensory noun; no honest single-frame picture", pos: "noun" },
  { id: "kemuri", kana: "けむり", kanji: "煙", romaji: "kemuri", meaningEn: "smoke", shortGloss: "smoke", fromModule: "m44", introducedByLessonId: "ja-m44-neo-1", kind: "vocab", blocked: true, note: "abstract sensory noun; no honest single-frame picture", pos: "noun" },
  { id: "koori", kana: "こおり", kanji: "氷", romaji: "koori", meaningEn: "ice", shortGloss: "ice", emoji: "🧊", fromModule: "m44", introducedByLessonId: "ja-m44-neo-1", kind: "vocab", blocked: true, note: "IR marks this one imageable:true (a real single-frame referent, unlike its three sensory-domain siblings) — 🧊 kept here as the flashcard/legacy art carrier; the modern compiler's own word_image_mcq debut is driven by the IR flag, not this row", pos: "noun" },
  { id: "you-evidential", kana: "よう", romaji: "you", meaningEn: "way, manner, appearance (grammar carrier for ようだ/みたい/のように/のような)", shortGloss: "seems (grammar)", fromModule: "m44", introducedByLessonId: "ja-m44-neo-2", kind: "vocab", blocked: true, note: "bound grammar-carrier noun — no concrete referent, mirrors はず's (m43) and こと/つもり's registration template. `id` disambiguated with an -evidential suffix: よう is also the volitional-form kana ending (う-verb たべよう class), an unrelated grammatical morpheme with no courseAtoms row of its own to collide with, but the suffix keeps this id self-documenting against any future volitional-noun registration", pos: "noun" },
  { id: "mitai-evidential", kana: "みたい", romaji: "mitai", meaningEn: "seems like, looks like", shortGloss: "seems like", fromModule: "m44", introducedByLessonId: "ja-m44-neo-5", kind: "vocab", blocked: true, note: "HOMOGRAPH RULING (brief-confirmed): this kana string みたい already exists as m13's own IR-local newAtom, the tai-form of みる, \"want to watch\" (見たい) — a completely different sense with no courseAtoms row (m13 never registered it here). No id collision is possible since m13's みたい was never added to this file. At the compiled-module layer, atomIndex()'s courseAtoms→priorAtoms→newAtoms last-wins ordering means m44's own IR newAtoms row (kind vocab, this same gloss) already wins for m44's own lessons regardless of this registry row; this row exists for canonical registry/SRS/flashcard purposes only, `id` disambiguated with an -evidential suffix so it can never be confused with a future みる-derived id", pos: "expression" },
  { id: "chigai", kana: "ちがい", kanji: "違い", romaji: "chigai", meaningEn: "difference", shortGloss: "difference", fromModule: "m44", introducedByLessonId: "ja-m44-neo-6", kind: "vocab", blocked: true, note: "abstract comparison noun; no honest single-frame picture. Deverbal from ちがう (\"to differ/be wrong\", m24) — distinct courseAtoms row, no derivedFrom chain needed since it functions as its own noun here, not a conjugated verb surface", pos: "noun" },
  { id: "tokuchou", kana: "とくちょう", kanji: "特徴", romaji: "tokuchou", meaningEn: "characteristic, distinguishing feature", shortGloss: "characteristic", fromModule: "m44", introducedByLessonId: "ja-m44-neo-6", kind: "vocab", blocked: true, note: "abstract descriptive noun; no honest single-frame picture", pos: "noun" },
  { id: "kagami", kana: "かがみ", kanji: "鏡", romaji: "kagami", meaningEn: "mirror", shortGloss: "mirror", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "IR marks imageable:false — a mirror's own referent reads as glass/reflection ambiguity risk under a single MCQ frame, kept recognition/build-beat only, no honest single-frame picture per the brief's imageable-discipline note", pos: "noun" },
  { id: "ningyou", kana: "にんぎょう", kanji: "人形", romaji: "ningyou", meaningEn: "doll", shortGloss: "doll", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "IR marks imageable:false — a single doll-frame risks reading as a specific toy brand rather than the word's abstract referent, kept recognition/build-beat only per the brief's imageable-discipline note", pos: "noun" },
  { id: "sokkuri", kana: "そっくり", romaji: "sokkuri", meaningEn: "exactly alike, a perfect match", shortGloss: "exactly alike", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "na-adjective of resemblance; no honest single-frame picture (a resemblance judgment needs two referents in frame, not one). Gloss reworded off the idiom \"spitting image\" — GATE 8's progressive-gloss lint reads the substring \"spitting\" as an English -ing progressive verb form and false-flags it against this module's plain non-past sentences", pos: "adjective", conjugation: { class: "na-adj" } },
  { id: "niru", kana: "にる", kanji: "似る", romaji: "niru", meaningEn: "to resemble", shortGloss: "to resemble", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "abstract stative verb; no honest single-frame picture (resemblance is relational, not a depictable action). Ichidan — drops る before an ending (に+ている, this module's own て-iru resultative row). Kept in bare dictionary form as its own graded target; にている registered separately as an IR-local derived verb-form newAtom (DERIVED_KINDS-exempt, no courseAtoms row of its own)", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "funiki", kana: "ふんいき", kanji: "雰囲気", romaji: "fun'iki", meaningEn: "atmosphere, mood", shortGloss: "atmosphere", fromModule: "m44", introducedByLessonId: "ja-m44-neo-9", kind: "vocab", blocked: true, note: "abstract collective-impression noun; no honest single-frame picture", pos: "noun" },
  { id: "kizashi", kana: "きざし", kanji: "兆し", romaji: "kizashi", meaningEn: "sign, omen", shortGloss: "sign", fromModule: "m44", introducedByLessonId: "ja-m44-neo-9", kind: "vocab", blocked: true, note: "abstract inferential noun; no honest single-frame picture", pos: "noun" },
  { id: "yousu", kana: "ようす", kanji: "様子", romaji: "yousu", meaningEn: "state of things, condition, appearance", shortGloss: "condition", fromModule: "m44", introducedByLessonId: "ja-m44-neo-9", kind: "vocab", blocked: true, note: "abstract descriptive noun; no honest single-frame picture. Distinct kana string from よう (id you-evidential, this module's own grammar carrier) — no atomIndex() collision, ようす is 3 kana and always wins longest-match at its own position", pos: "noun" },
  { id: "oya", kana: "おや", kanji: "親", romaji: "oya", meaningEn: "parent, parents", shortGloss: "parent", fromModule: "m45", introducedByLessonId: "ja-m45-neo-1", kind: "vocab", blocked: true, note: "family-register noun (spine's causative carrier — a parent is the canonical causer). No single-frame picture distinct from existing father/mother emoji already owned by ちち/はは; kept text-only rather than reusing their glyphs as a distractor", pos: "noun" },
  { id: "shikata", kana: "しかた", kanji: "仕方", romaji: "shikata", meaningEn: "way of doing something, method", shortGloss: "way (of doing)", fromModule: "m45", introducedByLessonId: "ja-m45-neo-2", kind: "vocab", blocked: true, note: "abstract manner noun; no honest single-frame picture. Debuts inside the fixed idiom しかたが ない, \"it can't be helped\" — ない here is the already-known existence-negation い-adjective, not a verb nai-form", pos: "noun" },
  { id: "muriyari", kana: "むりやり", romaji: "muriyari", meaningEn: "forcibly, against one's will", shortGloss: "forcibly", fromModule: "m45", introducedByLessonId: "ja-m45-neo-3", kind: "vocab", blocked: true, note: "manner adverb; no honest single-frame picture. The MAKE-reading signal word for this module's causative sentences (docs/ja-m45-brief-2026-09-10.md §4)", pos: "adverb" },
  { id: "makaseru", kana: "まかせる", kanji: "任せる", romaji: "makaseru", meaningEn: "to entrust, to leave (a matter) to someone", shortGloss: "entrust", fromModule: "m45", introducedByLessonId: "ja-m45-neo-4", kind: "vocab", blocked: true, note: "abstract transfer-of-responsibility verb; no honest single-frame picture. Kept in bare dictionary form throughout this module (brief's own \"awkward as a causative host, likely skip\" guidance) — zero conjugated surfaces registered", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "sewa", kana: "せわ", kanji: "世話", romaji: "sewa", meaningEn: "care, looking after (someone)", shortGloss: "care (of someone)", fromModule: "m45", introducedByLessonId: "ja-m45-neo-4", kind: "vocab", blocked: true, note: "abstract caretaking noun; no honest single-frame picture. Composes with the already-known する (id suru, m11) for せわをする, \"to look after\"", pos: "noun" },
  { id: "sodateru", kana: "そだてる", kanji: "育てる", romaji: "sodateru", meaningEn: "to raise, to bring up (a child, a plant)", shortGloss: "raise, bring up", fromModule: "m45", introducedByLessonId: "ja-m45-neo-6", kind: "vocab", blocked: true, note: "abstract nurture verb; no honest single-frame picture (raising a child spans years, not one frame). Ichidan — drops る before an ending; its causative そだてさせる is registered separately as an IR-local derived verb-form newAtom (DERIVED_KINDS-exempt)", pos: "verb", conjugation: { class: "ichidan" } },
  { id: "shitsuke", kana: "しつけ", kanji: "躾", romaji: "shitsuke", meaningEn: "discipline, upbringing", shortGloss: "discipline", fromModule: "m45", introducedByLessonId: "ja-m45-neo-6", kind: "vocab", blocked: true, note: "abstract child-rearing noun; no honest single-frame picture. Kanji 躾 is a kokuji (Japan-coined character) not on the jōyō list — kept kana-only in every sentence, matching this module's register discipline for its other rare-kanji nouns", pos: "noun" },
  { id: "kisoku", kana: "きそく", kanji: "規則", romaji: "kisoku", meaningEn: "rule, regulation", shortGloss: "rule", fromModule: "m45", introducedByLessonId: "ja-m45-neo-7", kind: "vocab", blocked: true, note: "abstract institutional noun; no honest single-frame picture", pos: "noun" },
  { id: "meirei", kana: "めいれい", kanji: "命令", romaji: "meirei", meaningEn: "order, command", shortGloss: "order, command", fromModule: "m45", introducedByLessonId: "ja-m45-neo-7", kind: "vocab", blocked: true, note: "abstract directive noun; no honest single-frame picture. Composes with the already-known する (id suru, m11) for めいれいする, \"to order/command\"", pos: "noun" },
  { id: "yurusu", kana: "ゆるす", kanji: "許す", romaji: "yurusu", meaningEn: "to forgive", shortGloss: "forgive, allow", fromModule: "m45", introducedByLessonId: "ja-m45-neo-7", kind: "vocab", blocked: true, note: "abstract permission verb; no honest single-frame picture. Godan — a-stem ゆるさ; its negative ゆるさない is registered separately as an IR-local derived verb-form newAtom (DERIVED_KINDS-exempt), needed for the idiom きそくは それを ゆるさない, \"the rules don't allow that\"", pos: "verb", conjugation: { class: "godan" } },
  { id: "naisho", kana: "ないしょ", kanji: "内緒", romaji: "naisho", meaningEn: "secret", shortGloss: "secret", fromModule: "m45", introducedByLessonId: "ja-m45-neo-8", kind: "vocab", blocked: true, note: "abstract noun; no honest single-frame picture", pos: "noun" },
  { id: "kyouiku", kana: "きょういく", kanji: "教育", romaji: "kyouiku", meaningEn: "education", shortGloss: "education", fromModule: "m45", introducedByLessonId: "ja-m45-neo-8", kind: "vocab", blocked: true, note: "abstract institutional noun; no honest single-frame picture. Sidequest vocabulary (docs/ja-m45-brief-2026-09-10.md §4), not core to the causative-mastery line", pos: "noun" },
  { id: "zangyou", kana: "ざんぎょう", kanji: "残業", romaji: "zangyou", meaningEn: "overtime work", shortGloss: "overtime", fromModule: "m45", introducedByLessonId: "ja-m45-neo-review-3", kind: "vocab", blocked: true, note: "abstract work-domain noun; no honest single-frame picture. Sidequest vocabulary (docs/ja-m45-brief-2026-09-10.md §4), debuts in review-3 as this module's final new lemma", pos: "noun" },
  { id: "aida", kana: "あいだ", kanji: "間", romaji: "aida", meaningEn: "space/time between — span or interval", shortGloss: "interval, span", fromModule: "m46", introducedByLessonId: "ja-m46-neo-1", kind: "vocab", blocked: true, note: "abstract interval noun, the shared host both aida-duration and aida-ni-point ride; no honest single-frame picture", pos: "noun" },
  { id: "saikin", kana: "さいきん", romaji: "saikin", meaningEn: "recently, lately", shortGloss: "recently", fromModule: "m46", introducedByLessonId: "ja-m46-neo-1", kind: "vocab", blocked: true, note: "abstract time adverb; no honest single-frame picture. Kana-only per this module's conservative kanji list", pos: "adverb" },
  { id: "tochuu", kana: "とちゅう", kanji: "途中", romaji: "tochuu", meaningEn: "on the way, midway", shortGloss: "on the way", fromModule: "m46", introducedByLessonId: "ja-m46-neo-2", kind: "vocab", blocked: true, note: "abstract locational-progress noun (L2's unrelated interleave-break carrier vocab, notes decision on never block-teaching the timing frames back to back); no honest single-frame picture", pos: "noun" },
  { id: "kyuuni", kana: "きゅうに", romaji: "kyuuni", meaningEn: "suddenly", shortGloss: "suddenly", fromModule: "m46", introducedByLessonId: "ja-m46-neo-3", kind: "vocab", blocked: true, note: "abstract manner adverb; no honest single-frame picture. Kana-only per this module's conservative kanji list — kyuuni distinct from the already-known きゅう \"nine\" (ja-m5-2-v-9), no kana collision", pos: "adverb" },
  { id: "bakari", kana: "ばかり", romaji: "bakari", meaningEn: "only, nothing but — a quantity limiter", shortGloss: "only, just", fromModule: "m46", introducedByLessonId: "ja-m46-neo-5", kind: "particle", blocked: true, note: "quantity-limiting particle, same lexeme this module's L7 たばかり (\"just did X\") rides temporally — one atom, two grammar cards (docs/ja-m46-brief-2026-09-10.md §3/§6). Kana-only per this module's conservative kanji list", pos: "particle" },
  { id: "zutsu", kana: "ずつ", romaji: "zutsu", meaningEn: "each, apiece — distributes a quantity evenly", shortGloss: "each, apiece", fromModule: "m46", introducedByLessonId: "ja-m46-neo-5", kind: "particle", blocked: true, note: "distributive particle attaching to a counted quantity; kana-only per this module's conservative kanji list", pos: "particle" },
  { id: "tsuzuku", kana: "つづく", kanji: "続く", romaji: "tsuzuku", meaningEn: "to continue, to go on (by itself)", shortGloss: "continue (itself)", fromModule: "m46", introducedByLessonId: "ja-m46-neo-6", kind: "vocab", blocked: true, note: "intransitive partner of the already-known transitive つづける (m30) — deepens the m33/m41 transitivity-family-noticing lens at negligible cost (brief §1e, §6.5). Abstract process verb; no honest single-frame picture distinct from つづける's own", pos: "verb", conjugation: { class: "godan" } },
  { id: "hisashiburi", kana: "ひさしぶり", kanji: "久しぶり", romaji: "hisashiburi", meaningEn: "it's been a while, long time no see", shortGloss: "long time no see", fromModule: "m46", introducedByLessonId: "ja-m46-neo-7", kind: "vocab", blocked: true, note: "fixed greeting expression; abstract, no single-frame picture", pos: "expression" },
  { id: "mama", kana: "まま", romaji: "mama", meaningEn: "as is, unchanged — leaving a state exactly as it was", shortGloss: "as is, staying so", fromModule: "m46", introducedByLessonId: "ja-m46-neo-8", kind: "vocab", blocked: true, note: "formal (keishiki) noun riding a modifier, same grammatical family as ところ — no independent referent, so no single-frame picture. Kana-only per this module's conservative kanji list", pos: "noun" },
  { id: "sonomama", kana: "そのまま", romaji: "sonomama", meaningEn: "as is", shortGloss: "just as is", fromModule: "m46", introducedByLessonId: "ja-m46-neo-8", kind: "vocab", blocked: true, note: "fused その (m1, already known) + まま; abstract manner expression, no single-frame picture. Kana-only per this module's conservative kanji list", pos: "expression" },
  { id: "isshun", kana: "いっしゅん", romaji: "isshun", meaningEn: "an instant, a moment", shortGloss: "an instant", fromModule: "m46", introducedByLessonId: "ja-m46-neo-8", kind: "vocab", blocked: true, note: "abstract time-quantity noun; no honest single-frame picture. Kana-only per this module's conservative kanji list", pos: "noun" },
];
