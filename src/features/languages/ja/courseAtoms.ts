...
const JA_COURSE_ATOMS_PART1: readonly CourseAtom[] = [
  ...
  { id: "erebeetaa", kana: "エレベーター", romaji: "erebeetaa", meaningEn: "an elevator", emoji: "🛗", fromModule: "m33", kind: "vocab", pos: "noun" },
...
const JA_COURSE_ATOMS_PART2: readonly CourseAtom[] = [
  ...
  { id: "yakusoku", kana: "やくそく", kanji: "約束", romaji: "yakusoku", meaningEn: "a promise", shortGloss: "promise", fromModule: "m43", introducedByLessonId: "ja-m43-neo-1", kind: "vocab", blocked: true, note: "abstract social-commitment noun; no honest single-frame picture", pos: "noun" },
  ...
  { id: "yosou", kana: "よそう", kanji: "予想", romaji: "yosou", meaningEn: "a prediction, a forecast", shortGloss: "prediction", fromModule: "m43", introducedByLessonId: "ja-m43-neo-4", kind: "vocab", blocked: true, note: "abstract cognition noun; no honest single-frame picture", pos: "noun" },
  ...
  { id: "chigai", kana: "ちがい", kanji: "違い", romaji: "chigai", meaningEn: "a difference", shortGloss: "difference", fromModule: "m44", introducedByLessonId: "ja-m44-neo-6", kind: "vocab", blocked: true, note: "abstract comparison noun; no honest single-frame picture. Deverbal from ちがう (\"to differ/be wrong\", m24) — distinct courseAtoms row, no derivedFrom chain needed since it functions as its own noun here, not a conjugated verb surface", pos: "noun" },
  { id: "tokuchou", kana: "とくちょう", kanji: "特徴", romaji: "tokuchou", meaningEn: "a characteristic, a distinguishing feature", shortGloss: "characteristic", fromModule: "m44", introducedByLessonId: "ja-m44-neo-6", kind: "vocab", blocked: true, note: "abstract descriptive noun; no honest single-frame picture", pos: "noun" },
  { id: "kagami", kana: "かがみ", kanji: "鏡", romaji: "kagami", meaningEn: "a mirror", shortGloss: "mirror", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "IR marks imageable:false — a mirror's own referent reads as glass/reflection ambiguity risk under a single MCQ frame, kept recognition/build-beat only, no honest single-frame picture per the brief's imageable-discipline note", pos: "noun" },
  { id: "ningyou", kana: "にんぎょう", kanji: "人形", romaji: "ningyou", meaningEn: "a doll", shortGloss: "doll", fromModule: "m44", introducedByLessonId: "ja-m44-neo-7", kind: "vocab", blocked: true, note: "IR marks imageable:false — a single doll-frame risks reading as a specific toy brand rather than the word's abstract referent, kept recognition/build-beat only per the brief's imageable-discipline note", pos: "noun" },
  ...
  { id: "kisoku", kana: "きそく", kanji: "規則", romaji: "kisoku", meaningEn: "a rule, a regulation", shortGloss: "rule", fromModule: "m45", introducedByLessonId: "ja-m45-neo-7", kind: "vocab", blocked: true, note: "abstract institutional noun; no honest single-frame picture", pos: "noun" },
  { id: "meirei", kana: "めいれい", kanji: "命令", romaji: "meirei", meaningEn: "an order, a command", shortGloss: "order, command", fromModule: "m45", introducedByLessonId: "ja-m45-neo-7", kind: "vocab", blocked: true, note: "abstract directive noun; no honest single-frame picture. Composes with the already-known する (id suru, m11) for めいれいする, \"to order/command\"", pos: "noun" },
  ...
  { id: "naisho", kana: "ないしょ", kanji: "内緒", romaji: "naisho", meaningEn: "a secret", shortGloss: "secret", fromModule: "m45", introducedByLessonId: "ja-m45-neo-8", kind: "vocab", blocked: true, note: "abstract noun; no honest single-frame picture", pos: "noun" },
  ...
  { id: "aida", kana: "あいだ", kanji: "間", romaji: "aida", meaningEn: "the space/time between — a span or interval", shortGloss: "interval, span", fromModule: "m46", introducedByLessonId: "ja-m46-neo-1", kind: "vocab", blocked: true, note: "abstract interval noun, the shared host both aida-duration and aida-ni-point ride; no honest single-frame picture", pos: "noun" },
