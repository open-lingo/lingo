...
export const JA_COURSE_ATOMS: ReadonlyArray<CourseAtom> = [
  ...
  { id: "ja-m7-1-v-yomu", kana: "よむ", kanji: "読む", romaji: "yomu", meaningEn: "to read", emoji: "📖", fromModule: "m16", kind: "vocab", blocked: true, note: "taught by m16 vocab pack 5 2026-07-30 (B067); was m7 with a dead ja-m7-1 attribution — deleted. blocked: 📖 belongs to ほん", pos: "verb", conjugation: { class: "godan", entryId: "yomu" } },
