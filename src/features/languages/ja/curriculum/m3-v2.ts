...
export const M3_2_2: LessonContent = {
  ...
  steps: [
    listeningBuildSentence({
      ...
      target: "せんせいは にほんじんです",
      tiles: ["は", "にほんじん", "か", "がくせい", "です", "せんせい"],
      correctOrder: ["せんせい", "は", "にほんじん", "です"],
    ...
    build(
      ...
      "Ask: Is the teacher American?",
      "せんせいは アメリカじんですか",
      ["は", "せんせい", "アメリカじん", "か", "にほんじん", "です"],
      ["せんせい", "は", "アメリカじん", "です", "か"],
    ),
    selfExplain({
...
export const M3_4_1: LessonContent = {
  ...
  steps: [
    ...
    cloze(
      ...
      "The flower is red.",
      "はなは あかいです。",
      "Topic = the flower. はなは = 'as for the flower.'",
    ),
    sentenceMcq({
    ...
    listeningCompSentence({
      ...
      audioText: "それは みずです",
      correctMeaningEn: "That is water.",
      distractorsEn: [
        "This is water.",
        "That is a book.",
        "Is that water?",
    ...
    cloze(
      ...
      "What is that over there?",
      "あれは なんですか。",
      "Question-word sentence + final か to ask.",
    ),
    sentenceMcq({
      id: "ja-m3-4-1-mcq-name",
      prompt: "Which sentence asks 'What is that (near you)?'",
      correctKana: "それは なんですか。",
      distractorsKana: [
        "それは なんです。",
        "それは ほんですか。",
        "それは みずですか。",
      ...
      explanation:
        "なん = 'what' — それは なんですか asks what something is. The yes/no options ask about a specific thing, and それは なんです is missing か.",
    }),
    cloze(
      "ja-m3-4-1-cloze-5",
      "そら",
...
export const M3_4_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      tiles: ["か", "アメリカじん", "は", "ともだち", "にほんじん", "です"],
    ...
    listeningCompSentence({
      ...
      audioText: "ともだちですか",
      correctMeaningEn: "Is that your friend?",
      distractorsEn: [
        "It's my friend.",
        "Are you a student?",
        "Is that a teacher?",
    ...
    selfExplain({
      ...
      anchorLabel: "You picked は in: ねこ＿ いぬです",
      anchorAudioText: "ねこは いぬです",
...
export const M3_5_1: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "あには にほんじんです",
      ["アメリカじん", "にほんじん", "あに", "は", "です"],
      ["あに", "は", "にほんじん", "です"],
    ),
    listeningBuildSentence({
      id: "ja-m3-5-1-lb-name",
      target: "あれは なんですか",
      tiles: ["なん", "あれ", "か", "は", "それ", "です", "これ"],
      correctOrder: ["あれ", "は", "なん", "です", "か"],
      promptEn: "What is that over there?",
    }),
    cloze(
      "ja-m3-5-1-cloze-3",
      "せんせい",
    ...
    speaking(
      ...
      "あには げんきです",
      "My older brother is doing well.",
    ),
    cloze(
      "ja-m3-5-1-cloze-4",
      "これは コーヒーです",
      ...
      "Is this coffee?",
      "これは コーヒーですか。",
      "Statement + か at the end to ask.",
    ),
    listeningCompSentence({
      id: "ja-m3-5-1-lc-are",
      audioText: "それは みずですか",
      correctMeaningEn: "Is that water?",
      distractorsEn: [
        "That is water.",
        "Is this water?",
        "Is that coffee?",
...
export const M3_5_2: LessonContent = {
  ...
  steps: [
    ...
    selfExplain({
      ...
      anchorLabel: "Compare: あれは ねこです vs あれは ねこですか",
      anchorAudioText: "あれは ねこですか",
      question:
    ...
    listeningBuildSentence({
      ...
      target: "ともだちは げんきですか",
      tiles: ["げんき", "は", "ともだち", "か", "せんせい", "です"],
      correctOrder: ["ともだち", "は", "げんき", "です", "か"],
      promptEn: "Is your friend doing well?",
    }),
    speaking(
...
export const M3_6_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      target: "ともだちですか",
      tiles: ["は", "ともだち", "わたし", "か", "です"],
      correctOrder: ["ともだち", "です", "か"],
      promptEn: "Is that your friend?",
    }),
    build(
      "ja-m3-6-2-s4",
      "Is that a cat?",
    ...
    listeningCompSentence({
      ...
      audioText: "あれは ごはんですか",
      correctMeaningEn: "Is that (over there) rice?",
      distractorsEn: [
        "That is rice.",
        "Is this rice?",
        "Is that water?",
...
export const M3_7_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "あれは なんですか",
      correctMeaningEn: "What is that over there?",
      distractorsEn: [
        "I am a student.",
        "Are you a teacher?",
        "Excuse me.",
...
export const M3_9: LessonContent = {
  ...
  steps: [
    ...
    dialogueListen({
      id: "ja-m3-9-scene-1",
      lines: [
        { speaker: "ゆき", kana: "すみません。がくせいですか。" },
        { speaker: "たけし", kana: "はい、がくせいです。わたしは たけしです。" },
        { speaker: "ゆき", kana: "わたしは ゆきです。" },
      ],
      questions: [
        {
          id: "s1-q1",
          prompt: "What does ゆき ask first?",
          correctText: "Whether たけし is a student",
          distractors: ["What たけし's name is", "Whether たけし is a teacher", "Whether たけし is American"],
          explanation: "がくせいですか = 'Are you a student?'",
        },
        {
          id: "s1-q2",
          prompt: "Who gives their name first?",
          correctText: "たけし",
          distractors: ["ゆき", "Both at the same time", "Neither"],
          explanation: "たけし answers, then adds わたしは たけしです = 'I am Takeshi.'",
        },
      ],
    }),
    build(
      ...
      "わたしは がくせいです",
      ["がくせい", "です", "わたし", "も", "は", "せんせい"],
      ["わたし", "は", "がくせい", "です"],
    ),
    sentenceMcq({
      id: "ja-m3-9-mcq-yuki-intro",
      prompt: "How does ゆき give her own name?",
      correctKana: "わたしは ゆきです。",
      distractorsKana: [
        "わたしは たけしです。",
        "わたしも たけしです。",
        "ゆきですか。",
      ],
      explanation: "わたしは ゆきです = 'I am Yuki.' — name as the topic with は.",
    }),
    dialogueListen({
      id: "ja-m3-9-scene-2",
      lines: [
        { speaker: "たけし", kana: "ゆきは にほんじんですか。" },
        { speaker: "ゆき", kana: "はい、にほんじんです。" },
        { speaker: "ゆき", kana: "たけしも にほんじんですか。" },
        { speaker: "たけし", kana: "アメリカじんです。" },
      ],
      questions: [
        {
          id: "s2-q1",
          prompt: "Is たけし Japanese?",
          correctText: "No — he's American",
          distractors: ["Yes", "It isn't said", "He's both"],
          explanation: "たけし answers アメリカじんです = 'I'm American.'",
        },
        {
          id: "s2-q2",
          prompt: "What does ゆき's も ask?",
          correctText: "Whether たけし is ALSO Japanese",
          distractors: ["Whether たけし is a student", "What たけし's name is", "Whether ゆき is Japanese"],
          explanation: "たけしも にほんじんですか — も replaces は to mean 'also/too.'",
        },
      ],
    }),
    cloze(
      "ja-m3-9-cloze-mo",
      "ともだち",
      " がくせいです。 (My friend is ALSO a student.)",
      "も",
      ["も", "は", "が", "を"],
    ...
    listeningBuildSentence({
      ...
      target: "ゆきは にほんじんですか",
      tiles: ["も", "です", "ゆき", "か", "は", "にほんじん"],
      correctOrder: ["ゆき", "は", "にほんじん", "です", "か"],
      promptEn: "Hear it, build it: 'Is Yuki Japanese?'",
    }),
    speaking(
      "ja-m3-9-speak-intro",
      "わたしは たけしです",
