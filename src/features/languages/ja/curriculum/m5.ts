...
export const M5_3_1: LessonContent = {
  ...
  steps: [
    ...
    sentenceMcq({
      ...
      prompt: "Which sentence says 'Water, please.'?",
      correctKana: "みず ください。",
      distractorsKana: [
        "みず です。",
        "みず ですか。",
    ...
    // Cloze 2 — rotate answer (は as topic marker in a price question)
    cloze(
      "ja-m5-3-1-cloze-2",
      "コーヒー",
      " なん ですか。",
      "は",
      ["は", "が", "の", "を"],
      "What is the coffee? (identity question)",
      "コーヒーは なん ですか。",
      "は marks the topic ('as for the coffee').",
    ),
    build(
    ...
    speaking("ja-m5-3-1-speak-coffee", "コーヒー ください", "Coffee, please."),
    listeningCompSentence({
    ...
    infoStep(
      ...
      "The magic request word: item + ください. コーヒー ください, みず ください, ビール ください — polite enough for any shop or restaurant.",
      "win",
    ),
  ],
};
...
export const M5_3_2: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "Two coffees, please. (2 things)",
      "コーヒー ふたつ ください",
      ["コーヒー", "ふたつ", "ください", "みっつ"],
      ["コーヒー", "ふたつ", "ください"],
    ),
    speaking("ja-m5-3-2-speak-futatsu", "コーヒー ふたつ ください", "Two coffees, please."),
    ...
    speaking("ja-m5-3-2-speak-mittsu", "ビール みっつ ください", "Three beers, please."),
    listeningBuildSentence({
      id: "ja-m5-3-2-lb-hitotsu",
      target: "みず ひとつ ください",
      tiles: ["みず", "ひとつ", "ください", "ふたつ"],
...
export const M5_4_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m5-4-1-lb-futari",
      target: "ふたり です",
      tiles: ["ふたり", "ひとり", "です", "ください"],
      correctOrder: ["ふたり", "です"],
      promptEn: "Hear it, build it: '(A table for) two.'",
    }),
    sentenceMcq({
    ...
    build(
      "ja-m5-4-1-build-hitori2",
      "(A table for) 1.",
      "ひとり です",
      ["ひとり", "ふたり", "です", "いち"],
      ["ひとり", "です"],
    ),
    speaking("ja-m5-4-1-speak-hitori", "ひとり です", "(A table for) one."),
    selfExplain({
...
export const M5_4_2: LessonContent = {
  ...
  steps: [
    ...
    speaking("ja-m5-4-2-speak-gonin", "ごにん です", "(A table for) five."),
    listeningBuildSentence({
...
export const M5_5_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "おちゃ ふたつ ください",
      correctMeaningEn: "Two green teas, please.",
      distractorsEn: [
    ...
    build(
      "ja-m5-5-2-build-3water",
      "Three waters, please.",
      "みず みっつ ください",
      ["みず", "みっつ", "ください", "ひとつ"],
      ["みず", "みっつ", "ください"],
    ),
    speaking("ja-m5-5-2-speak-order", "おちゃ みっつ ください", "Three green teas, please."),
    listeningBuildSentence({
      id: "ja-m5-5-2-lb-order",
      target: "ビール ふたつ ください",
      tiles: ["ビール", "ふたつ", "ください", "みっつ"],
      correctOrder: ["ビール", "ふたり", "ください"],
      promptEn: "Hear it, build it: 'Two beers, please.'",
    }),
    sentenceMcq({
      id: "ja-m5-5-2-mcq-3coffees",
      prompt: "Which sentence orders THREE coffees?",
...
export const M5_STORY: LessonContent = {
  ...
  steps: [
    ...
    dialogueListen({
      ...
      lines: [
        { speaker: "ゆき", kana: "コーヒー ふたつ ください。" },
        { speaker: "たけし", kana: "わたしは ビール ひとつ ください。" },
        { speaker: "ゆき", kana: "ビールですか。" },
        { speaker: "たけし", kana: "はい、ビールです。" },
      ],
      questions: [
        {
          id: "s1-q1",
          prompt: "How many coffees does ゆき order?",
          correctText: "Two",
          distractors: ["One", "Three", "None"],
          explanation: "コーヒー ふたつ ください = 'Two coffees, please.' ふたつ = 2 things.",
        },
        {
          id: "s1-q2",
          prompt: "What does たけし order?",
          correctText: "One beer",
          distractors: ["Two coffees", "One coffee", "Two beers"],
          explanation: "ビール ひとつ ください = 'One beer, please.'",
        },
      ],
    }),
    build(
      ...
      "コーヒー ふたつ ください",
      ["コーヒー", "ふたつ", "ください", "ひとつ", "みっつ"],
      ["コーヒー", "ふたつ", "ください"],
    ),
    sentenceMcq({
      id: "ja-m5-story-mcq-beer",
      prompt: "Which sentence orders one beer?",
      correctKana: "ビール ひとつ ください",
      distractorsKana: [
        "ビール ふたつ ください",
        "コーヒー ひとつ ください",
        "ビール みっつ ください",
      ],
      explanation: "ビール = beer. ひとつ = 1 thing. ください = please.",
    }),
    dialogueListen({
    ...
    cloze(
      ...
      "コーヒー ",
      " ください。 (Two coffees, please.)",
      "ふたつ",
      ["ふたつ", "ひとつ", "みっつ", "ふたり"],
      "Two coffees, please.",
      "コーヒー ふたつ ください。",
      "ふたつ = 2 (things). ふたり = 2 (people). Use ふたつ for objects.",
    ),
    build(
      "ja-m5-story-build-sannin",
      "Say: There are three friends.",
      "ともだちは さんにんです",
      ["ともだち", "は", "さんにん", "です", "ふたり", "ひとり"],
      ["ともだち", "は", "さんにん", "です"],
    ),
    listeningBuildSentence({
      id: "ja-m5-story-lb-order",
      target: "コーヒー みっつ ください",
      tiles: ["コーヒー", "みっつ", "ください", "ふたつ", "ビール"],
...
export const M5_6_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      correctMeaningEn: "I'm from America.",
      distractorsEn: ["I'm American.", "America is big.", "I went to America."],
    }),
    cloze(
      "ja-m5-6-1-cloze-1",
      "わたしは アメリカ",
    ...
    speaking("ja-m5-6-1-speak-kara", "わたしは アメリカから です", "I'm from America."),
    // ── にほんから ──
    build(
    ...
    build(
      ...
      "せんせいは アメリカから です",
      ["せんせい", "は", "アメリカ", "から", "です", "にほん"],
      ["せんせい", "は", "アメリカ", "から", "です"],
    ),
    speaking("ja-m5-6-1-speak-nihon", "にほんから です", "(I'm) from Japan."),
    selfExplain({
...
export const M5_6_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      target: "みず みっつ ください",
      tiles: ["みず", "みっつ", "ください", "ふたつ"],
      correctOrder: ["みず", "みっつ", "ください"],
      promptEn: "Hear it, build it: 'Three waters, please.'",
    }),
    build(
    ...
    speaking("ja-m5-6-2-speak-order", "おちゃ ふたつ ください", "Two green teas, please."),
    // ── Review tail ──
...
export const M5_7_1: LessonContent = {
  ...
  steps: [
    ...
    speaking("ja-m5-7-1-speak-s1", "みず ください", "Water, please."),
    build(
      "ja-m5-7-1-build-s2",
      "Two coffees, please.",
      "コーヒー ふたつ ください",
    ...
    speaking("ja-m5-7-1-speak-s2", "コーヒー ふたつ ください", "Two coffees, please."),
    listeningCompSentence({
    ...
    speaking("ja-m5-7-1-speak-price", "これは いくら ですか", "How much is this?"),
    listeningBuildSentence({
      id: "ja-m5-7-1-lb-3people",
      target: "さんにん です",
    ...
    speaking("ja-m5-7-1-speak-from", "わたしは アメリカから です", "I'm from America."),
    sentenceMcq({
...
export const M5_7_2: LessonContent = {
  ...
  steps: [
    ...
    cloze(
      ...
      "My friend is from America.",
      "ともだちは アメリカから です。",
      "Topic は; origin から. Both stack in one sentence.",
    ),
    // Production
    build(
    ...
    speaking("ja-m5-7-2-speak-order", "コーヒー ふたつ ください", "Two coffees, please."),
    build(
    ...
    sentenceMcq({
      ...
      explanation: "みっつ = 3 generic things. さんにん is 3 people (wrong counter for coffee); さん is for math.",
    }),
    selfExplain({
