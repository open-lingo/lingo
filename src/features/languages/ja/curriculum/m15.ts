...
export const M15_1_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      tiles: ["いま", "べんきょう", "して", "います", "します", "しました"],
...
export const M15_1_2: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "Say: I live in Osaka.",
      "おおさかに すんでいます",
      ["おおさか", "に", "すんで", "います", "いきます", "すみます"],
      ["おおさか", "に", "すんで", "います"],
    ),
    sentenceMcq({
      id: "ja-m15-1-2-mcq-sundeiru",
      prompt: "Which sentence means 'I live in Tokyo'?",
      correctKana: "とうきょうに すんでいます。",
      distractorsKana: [
        "とうきょうに すみます。",
        "とうきょうに いきます。",
        "とうきょうに いました。",
      ],
      explanation: "すんでいます = 'live in' (resultative ている). すみます would mean 'will move to.'",
    }),
...
export const M15_2_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      tiles: ["いま", "かいもの", "を", "して", "います", "します", "しました"],
...
export const M15_3_1: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "Ask: May I sit here?",
      "ここに すわってもいいですか",
      ["ここ", "に", "すわって", "も", "いいですか", "すわります", "いいです"],
      ["ここ", "に", "すわって", "も", "いいですか"],
    ),
    listeningCompSentence({
      id: "ja-m15-3-1-lc-suwatte",
      audioText: "ここに すわってもいいですか",
    ...
    listeningBuildSentence({
      ...
      target: "しゃしんを とってもいいですか",
      tiles: ["しゃしん", "を", "とって", "も", "いいですか", "とります", "いいです"],
      correctOrder: ["しゃしん", "を", "とって", "も", "いいですか"],
      promptEn: "Hear it, build it: 'May I take a photo?'",
    }),
    sentenceMcq({
...
export const M15_3_2: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "Ask: May I go home?",
      "かえってもいいですか",
      ["かえって", "も", "いいですか", "かえります", "いいです", "かえりました"],
      ["かえって", "も", "いいですか"],
    ),
    listeningCompSentence({
      id: "ja-m15-3-2-lc-kaette",
      audioText: "かえってもいいですか",
      correctMeaningEn: "May I go home?",
      distractorsEn: [
        "I'm going home.",
        "I went home.",
        "Please go home.",
    ...
    listeningBuildSentence({
      id: "ja-m15-3-2-lb-kaette",
      target: "かえってもいいですか",
      tiles: ["かえって", "も", "いいですか", "かえります", "いいです"],
      correctOrder: ["かえって", "も", "いいですか"],
      promptEn: "Hear it, build it: 'May I go home?'",
    }),
    cloze(
      "ja-m15-3-2-cloze-totte",
      "しゃしんを とって",
      "いいですか。",
      "も",
      ["も", "は", "を", "が"],
...
export const M15_4_1: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "すしを たべたいです",
      ["すし", "を", "たべたい", "です", "たべます", "たべて"],
      ["すし", "を", "たべたい", "です"],
    ),
    listeningCompSentence({
      id: "ja-m15-4-1-lc-tabetai",
      audioText: "すしを たべたいです",
      correctMeaningEn: "I want to eat sushi.",
      distractorsEn: [
        "I'm eating sushi.",
        "I ate sushi.",
        "I don't eat sushi.",
    ...
    build(
      ...
      "いきたくないです",
      ["いきたくない", "です", "いきたい", "いきません"],
      ["いきたくない", "です"],
    ),
    listeningBuildSentence({
      id: "ja-m15-4-1-lb-tai",
      target: "にほんに いきたいです",
      tiles: ["にほん", "に", "いきたい", "です", "いきます", "いきたくない"],
      correctOrder: ["にほん", "に", "いきたい", "です"],
      promptEn: "Hear it, build it: 'I want to go to Japan.'",
    }),
    selfExplain({
...
export const M15_5_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      id: "ja-m15-5-1-lc-mizu",
      audioText: "みずが ほしいです",
      correctMeaningEn: "I want water.",
      distractorsEn: [
        "I'm drinking water.",
    ...
    build(
      ...
      "Say: I want time.",
      "じかんが ほしいです",
      ["じかん", "が", "ほしい", "です", "を", "ほしくない"],
      ["じかん", "が", "ほしい", "です"],
    ),
    speaking("ja-m15-5-1-speak-hoshii", "みずが ほしいです", "I want water."),
    // ── ほしくない (negative) ──
    cloze(
    ...
    listeningBuildSentence({
      ...
      target: "あたらしい くつが ほしいです",
      tiles: ["あたらしい", "くつ", "が", "ほしい", "です", "を", "ほしくない"],
      correctOrder: ["あたらしい", "くつ", "が", "ほしい", "です"],
      promptEn: "Hear it, build it: 'I want new shoes.'",
    }),
    cloze(
...
export const M15_5_2: LessonContent = {
  ...
  steps: [
    ...
    build(
      "ja-m15-5-2-build-hoshikunai",
      "Say: I don't want anything.",
      "なにも ほしくないです",
      ["なにも", "ほしくない", "です", "ほしい", "なにが"],
      ["なにも", "ほしくない", "です"],
    ),
    listeningBuildSentence({
      id: "ja-m15-5-2-lb-contrast",
      target: "くるまが ほしいです",
      tiles: ["くるま", "が", "ほしい", "です", "を", "ほしくない"],
...
export const M15_6_1: LessonContent = {
  ...
  steps: [
    ...
    build(
      ...
      "たべたいですけど じかんが ないです",
      ["たべたい", "です", "けど", "じかん", "が", "ないです", "あります"],
      ["たべたい", "です", "けど", "じかん", "が", "ないです"],
    ),
    listeningCompSentence({
      id: "ja-m15-6-1-lc-kedo-1",
      audioText: "たべたいですけど じかんが ないです",
      correctMeaningEn: "I want to eat, but I have no time.",
      distractorsEn: [
        "I ate, but I'm still hungry.",
        "I don't want to eat because I have no time.",
        "I want to eat and I have time.",
      ],
    }),
    cloze(
    ...
    build(
      ...
      ["くるま", "が", "ほしい", "です", "けど", "おかね", "が", "ないです", "あります"],
    ...
    build(
      ...
      "たかいですけど ほしいです",
      ["たかい", "です", "けど", "ほしい", "です", "やすい", "ほしくない"],
      ["たかい", "です", "けど", "ほしい", "です"],
    ),
    listeningBuildSentence({
      id: "ja-m15-6-1-lb-kedo",
      target: "たべたいですけど じかんが ないです",
      tiles: ["たべたい", "です", "けど", "じかん", "が", "ないです", "あります"],
      correctOrder: ["たべたい", "です", "けど", "じかん", "が", "ないです"],
      promptEn: "Hear it, build it: 'I want to eat, but I have no time.'",
    }),
    sentenceMcq({
...
export const M15_6_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "りょこうしたいですけど やすみが ないです",
      correctMeaningEn: "I want to travel, but I have no vacation.",
      distractorsEn: [
        "I traveled during vacation.",
        "I don't want to travel on vacation.",
        "I have vacation but don't want to travel.",
      ],
    }),
    ...
    cloze(
      ...
      "どこに いきたいですか。",
      "どこに = where to. いきたいですか = do you want to go?",
    ),
    sentenceMcq({
    ...
    listeningBuildSentence({
      ...
      target: "どこに いきたいですか",
      tiles: ["どこ", "に", "いきたい", "ですか", "いきます", "いきました"],
      correctOrder: ["どこ", "に", "いきたい", "ですか"],
      promptEn: "Hear it, build it: 'Where do you want to go?'",
    }),
    selfExplain({
...
// ═══════════════════════════════════════════════════════════════════════
// M15-STORY — Dialogue: friends planning a trip
// ═══════════════════════════════════════════════════════════════════════
...
export const M15_STORY: LessonContent = {
  ...
  description:
    "Listen to two friends discuss where they want to travel. Answer questions and practice key patterns.",
  estimatedMinutes: 5,
  xpReward: 15,
  steps: [
    infoStep(
      ...
      "ゆき and たけし are planning a trip together. Where do they want to go? What do they want to do? Listen and find out.",
    ),
    dialogueListen({
      id: "ja-m15-story-scene-1",
      lines: [
        { speaker: "ゆき", kana: "つぎの やすみに どこに いきたいですか。" },
        { speaker: "たけし", kana: "きょうとに いきたいですけど、おかねが ないです。" },
        { speaker: "ゆき", kana: "わたしも きょうとに いきたいです。おてらを みたいです。" },
        { speaker: "たけし", kana: "いいですね。でも、いま いそがしいです。" },
      ],
      questions: [
        {
          id: "s1-q1",
          prompt: "Where does たけし want to go?",
          correctText: "Kyoto.",
          distractors: ["Tokyo.", "Osaka.", "He doesn't want to travel."],
          explanation: "たけし says きょうとに いきたいですけど = 'I want to go to Kyoto, but...'",
        },
        {
          id: "s1-q2",
          ...
          explanation: "おかねが ないです = 'I have no money.'",
        },
      ],
    }),
    build(
      "ja-m15-story-build-1",
      "Say: I want to go to Kyoto.",
      "きょうとに いきたいです",
      ["きょうと", "に", "いきたい", "です", "いきます", "いきました"],
      ["きょうと", "に", "いきたい", "です"],
    ),
    sentenceMcq({
      id: "ja-m15-story-mcq-1",
      prompt: "What does ゆき want to see in Kyoto?",
      correctKana: "Temples.",
      distractorsKana: [
        "Movies.",
        "Friends.",
      ...
      explanation: "ゆき says おてらを みたいです = 'I want to see temples.'",
    }),
    dialogueListen({
      id: "ja-m15-story-scene-2",
      lines: [
        { speaker: "ゆき", kana: "きょうとで なにを したいですか。" },
        { speaker: "たけし", kana: "おいしい りょうりを たべたいです。それから、さんぽを したいです。" },
        { speaker: "ゆき", kana: "わたしも さんぽが すきです。いま、りょこうの ほんを よんでいます。" },
        { speaker: "たけし", kana: "いいですね。みてもいいですか。" },
      ],
      questions: [
        {
          id: "s2-q1",
          prompt: "What does たけし want to do in Kyoto?",
          correctText: "Eat delicious food and take walks.",
          distractors: ["Visit temples.", "Go shopping.", "Watch movies."],
          explanation: "おいしい りょうりを たべたい + さんぽを したい = eat delicious food and take walks.",
        },
        {
          id: "s2-q2",
          prompt: "What is ゆき doing right now?",
          correctText: "Reading a travel book.",
          distractors: ["Planning the trip.", "Cooking.", "Studying."],
          explanation: "りょこうの ほんを よんでいます = 'I'm reading a travel book.'",
        },
      ],
    }),
    cloze(
      "ja-m15-story-cloze-1",
      "おいしい りょうりを ",
      "です。",
      "たべたい",
      ["たべたい", "たべます", "たべて", "たべている"],
    ...
    listeningBuildSentence({
      id: "ja-m15-story-lb-1",
      target: "きょうとに いきたいですけど おかねが ないです",
      tiles: ["きょうと", "に", "いきたい", "です", "けど", "おかね", "が", "ないです"],
      correctOrder: ["きょうと", "に", "いきたい", "です", "けど", "おかね", "が", "ないです"],
      promptEn: "Hear it, build it: 'I want to go to Kyoto, but I have no money.'",
    }),
    listeningCompSentence({
      id: "ja-m15-story-lc-1",
      audioText: "みてもいいですか",
      correctMeaningEn: "May I see (it)?",
      distractorsEn: [
        "I'm looking at it.",
        "I saw it.",
        "I want to see it.",
    ...
    sentenceMcq({
      ...
      prompt: "What do both ゆき and たけし have in common?",
      correctKana: "They both want to go to Kyoto.",
      distractorsKana: [
        "They both have money.",
        "They both like cooking.",
        "They both are reading a book.",
      ],
      explanation: "Both say きょうとに いきたい. ゆき adds わたしも = 'me too.'",
    }),
    speaking(
    ...
    infoStep(
      ...
      "You followed two friends planning a real trip in Japanese",
      "You heard いきたいですけど, たべたい, みてもいいですか, and よんでいます — all woven into a natural conversation about travel.",
      "win",
    ),
  ],
};
...
export const M15_7_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      ...
      tiles: ["えいが", "を", "みたい", "です", "けど", "じかん", "が", "ないです"],
