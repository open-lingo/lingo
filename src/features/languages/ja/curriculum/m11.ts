...
export const M11_2_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-2-1-lb-1",
      target: "きのう みませんでした",
      tiles: ["よく", "みませんでした", "きのう", "みました", "みません"],
...
export const M11_2_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-2-2-lb-1",
      target: "きのう いきませんでした",
      tiles: ["いきませんでした", "いきません", "たいてい", "きのう", "いきました"],
...
export const M11_3_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-3-1-lb-1",
      target: "あまり わかりません",
      tiles: ["ぜんぜん", "のみません", "わかります", "わかりません", "あまり"],
...
export const M11_3_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-3-2-lb-1",
      target: "ぜんぜん のみません",
      tiles: ["あまり", "のみません", "ぜんぜん", "のみます", "たべません"],
...
export const M11_4_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-4-1-lb-1",
      target: "みない",
      tiles: ["みません", "たべない", "こない", "みない"],
      correctOrder: ["みない"],
      promptEn: "Hear it, pick it: 'don't watch (casual)'",
    }),
    selfExplain({
      id: "ja-m11-4-1-self",
...
export const M11_5_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-5-1-lb-1",
      target: "まだ のんでいません",
      tiles: ["のみました", "のんでいません", "もう", "のみません", "まだ"],
...
export const M11_5_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-5-2-lb-1",
      target: "もう たべました",
      tiles: ["たべました", "たべていません", "まだ", "たべません", "もう"],
...
export const M11_7_1: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-7-1-lb-1",
      target: "まだ かいていません",
      tiles: ["かきました", "もう", "かいていません", "まだ", "かかない"],
      correctOrder: ["まだ", "かいていません"],
      promptEn: "Hear it, build it: 'I haven't written it yet.'",
    }),
    cloze(
      "ja-m11-7-1-cloze-3",
      "もう ",
...
export const M11_7_2: LessonContent = {
  ...
  steps: [
    ...
    listeningBuildSentence({
      id: "ja-m11-7-2-lb-1",
      target: "ぜんぜん のみません",
      tiles: ["あまり", "のみません", "ぜんぜん", "のみます", "のまない"],
      correctOrder: ["ぜんぜん", "のみません"],
      promptEn: "Hear it, build it: 'I don't drink at all.'",
    }),
    translateStep({
