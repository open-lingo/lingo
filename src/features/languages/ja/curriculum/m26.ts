...
export const M26_1_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "きょうは とても つかれました",
      correctMeaningEn: "I'm very tired today.",
      distractorsEn: [
        "I'm very busy today.",
        "I was late today.",
...
export const M26_1_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "つかれました。だから、うちに かえります",
      correctMeaningEn: "I'm tired, so I'm going home.",
      distractorsEn: [
        "I'm tired, but I'm going home.",
...
export const M26_2_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "あした えいがを みます",
      correctMeaningEn: "I'm going to watch a movie tomorrow.",
      distractorsEn: [
...
export const M26_3_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "おかねが ありません。だから、こまります",
      correctMeaningEn: "I have no money, so I'm in trouble.",
      distractorsEn: [
        "I have money, so it's fine.",
        "I have no time, so I'm in trouble.",
...
export const M26_3_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "アメリカに いった ことが ありますか",
      correctMeaningEn: "Have you ever been to America?",
      distractorsEn: [
...
export const M26_4_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "きのう コーヒーを のみすぎました",
      correctMeaningEn: "I drank too much coffee yesterday.",
      distractorsEn: [
        "I ate too much yesterday.",
        "I drank a little coffee yesterday.",
...
export const M26_5_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "この えいごの いみは なんですか",
      correctMeaningEn: "What does this English word mean?",
      distractorsEn: [
    ...
    listeningCompSentence({
      ...
      audioText: "きのう かさを かいました",
      correctMeaningEn: "I bought an umbrella yesterday.",
      distractorsEn: [
        "I bought a bag yesterday.",
        "I forgot my umbrella yesterday.",
        "I will buy an umbrella tomorrow.",
      ],
    }),
...
export const M26_6_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "なんじに うちに かえりますか",
      correctMeaningEn: "What time are you going home?",
      distractorsEn: [
        "When are you coming?",
        "What time is it now?",
        "Where are you going?",
...
export const M26_6_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "ペンを わすれたんです",
      correctMeaningEn: "The thing is, I forgot my pen.",
      distractorsEn: [
        "The thing is, I lost my bag.",
        "I have two pens.",
...
export const M26_7_1: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "ジュースを のみすぎたんです",
      correctMeaningEn: "The thing is, I drank too much juice.",
      distractorsEn: [
        "The thing is, I ate too much bread.",
        "I want to drink juice.",
        "I bought three juices.",
      ],
    }),
...
export const M26_7_2: LessonContent = {
  ...
  steps: [
    ...
    listeningCompSentence({
      ...
      audioText: "うちに かえりたいです",
      correctMeaningEn: "I want to go home.",
      distractorsEn: [
