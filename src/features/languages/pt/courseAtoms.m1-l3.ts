/**
 * Per-lesson atom fragment — m1 lesson 3. Scaffolding lane PTFRAG
 * (2026-09-18): five of these files exist so authoring lanes PTAUTH-L1..L5
 * can each own one file (paired with `curriculum/ir/m1/l3.ir.yaml`)
...
export const M1_L3_ATOMS: PtAtom[] = [];
