/**
 * Per-lesson atom fragment — m1 lesson 5. Scaffolding lane PTFRAG
 * (2026-09-18): five of these files exist so authoring lanes PTAUTH-L1..L5
 * can each own one file (paired with `curriculum/ir/m1/l5.ir.yaml`)
...
export const M1_L5_ATOMS: PtAtom[] = [];
