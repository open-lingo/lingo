/**
 * Per-lesson atom fragment — m1 lesson 1. Scaffolding lane PTFRAG
 * (2026-09-18): five of these files exist so authoring lanes PTAUTH-L1..L5
 * can each own one file (paired with `curriculum/ir/m1/l1.ir.yaml`)
...
export const M1_L1_ATOMS: PtAtom[] = [];
