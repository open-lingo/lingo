    ...
    ]),
    {
      ...
      turns: [
        ...
        },
        {
          ...
          goal: "Say you understand nothing.",
          reply: {
            mode: "choice",
            options: [
              { id: "correct", text: "je ne comprends rien !" },
              { id: "wrong-pas", text: "je ne comprends pas ça" },
              { id: "wrong-aime", text: "j'aime le café" },
            ],
            correctOptionId: "correct",
            audioText: "je ne comprends rien !",
          },
          replyGloss: "I understand nothing!",
        },
      ],
    },
  ];
