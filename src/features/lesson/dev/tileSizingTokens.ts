...
export const TILE_TOKEN_DEFS: readonly TileTokenDef[] = [
  ...
  { key: "--tile-box-h", label: "Tile height floor (lock uses this)", unit: "px", group: "build", section: "base", kind: "abs", min: 28, max: 80, step: 0.5, base: 32, sm: 0 },
  ...
  { key: "--big-py-scale", label: "Padding Y × base", unit: "", group: "build", section: "big", kind: "scale", min: 0.25, max: 3, step: 0.005, base: 1, sm: 1.5, absKey: "--big-py-abs", absUnit: "px", absMin: 0, absMax: 20, absStep: 0.25 },
  ...
  { key: "--listen-bank-py-scale", label: "Padding Y × base (bank)", unit: "", group: "build", section: "listen", kind: "scale", min: 0.5, max: 2.5, step: 0.005, base: 1.066667, sm: 2, absKey: "--listen-bank-py-abs", absUnit: "px", absMin: 0, absMax: 20, absStep: 0.25 },
