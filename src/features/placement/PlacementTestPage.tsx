...
export function PlacementTestPage() {
  ...
  // Test-outs (JA *and* KO) serve DERIVED sets — ~12 real lesson steps
  // sampled from the module's own lessons for section coverage — instead of
  // the legacy 3-per-module bank (Spencer 2026-07-13/07-15). Both languages
  // ship authored M3+ lessons, so derivation yields real questions. Full
  // placement keeps the authored bank: its screening/probing needs the
  // curated per-skill items.
