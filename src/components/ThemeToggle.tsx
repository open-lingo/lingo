...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="rounded-full p-2 text-gray-400 transition hover:bg-gray-700 hover:text-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
