...
export type SheetSide = "left" | "right" | "bottom" | "top";
...
const sideClasses: Record<SheetSide, string> = {
  ...
  bottom: "inset-x-0 bottom-0 max-h-[88vh] border-t rounded-t-2xl",
...
export type SheetProps = {
  open: boolean;
  onClose: () => void;
  /** Which edge the panel attaches to. Default `right` (desktop drawer); use `bottom` for mobile sheets. */
  side?: SheetSide;
  /** Header title. */
  title?: string;
  /** Footer slot. */
