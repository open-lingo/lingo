/**
 * Central place for route path and query param conventions.
 * Use these to build shareable URLs (embed, copy, deep link).
 */

/** Alphabet practice: path /practice/alphabet/:alphabetId or query ?name= */
