      ...
      modules: [
        ...
        },
        {
          ...
          lessons: [
            ...
            { id: "ja-m11-neo-10", title: "The week \u2014 \u301cようび", status: "available" as const },
            ...
            { id: "ja-m11-neo-trainer-ta", title: "Drill — the whole た table", status: "available" as const,
              kind: "trainer" as const, trainerTypeIds: ["ta-form"] },
        ...
        },
        {
          ...
          lessons: [
            ...
            { id: "ja-m13-neo-trainer-tai", title: "Drill — all four たい cells", status: "available" as const,
              kind: "trainer" as const, trainerTypeIds: ["v-tai", "nai-form"] },
        ...
        },
        {
          ...
          summary: "Japanese has no relative pronoun — you park a whole sentence in front of a noun and the verb does not change: ほんを みる ひと is the person who looks at books. The clause verb stays plain, its own subject takes が, and the same shape then gives you こと (naming an action), とき (saying when) and the ordering pair まえに / てから.",
          lessons: [
        ...
        // (m50). This module therefore contains no て-form of any verb at all.
        {
          ...
          tier: "n4",
          lessons: [
            { id: "ja-m31-neo-1", title: "「あげる」と「くれる」 — one present, two directions", status: "available" as const },
            { id: "ja-m31-neo-2", title: "「せんせいに じしょを もらう」 — the receiver takes the topic", status: "available" as const },
            { id: "ja-m31-neo-3", title: "「ともだちから もらう」 — に or から, and both are right", status: "available" as const },
            { id: "ja-m31-neo-review-1", title: "Review — which way is it going?", status: "available" as const },
            { id: "ja-m31-neo-5", title: "×「わたしに あげる」 — the one thing あげる cannot do", status: "available" as const },
            { id: "ja-m31-neo-6", title: "「もらった」「くれた」「あげた」 — after the present is handed over", status: "available" as const },
            { id: "ja-m31-neo-7", title: "「ともだちに かさを かりる」 — に, on a pair where the thing comes back", status: "available" as const },
            { id: "ja-m31-neo-review-2", title: "Review — three verbs, one arrow", status: "available" as const },
            { id: "ja-m31-neo-9", title: "「せんせいが くださった」 — the polite pair you only need to recognise", status: "available" as const },
            { id: "ja-m31-neo-10", title: "「わたしは」 が きえる — the verb has already said who", status: "available" as const },
            { id: "ja-m31-neo-11", title: "「あげたい」「もらいたい」 — wanting to give, wanting to get", status: "available" as const },
        ...
        {
          id: "m32",
          title: "Conditionals I — たら, and と as the contrast",
          eyebrow: "Module 32 · JLPT N4",
          summary: "The most useful conditional in the language is also the cheapest: take the plain past you have made since module 11 and put ら on the end. たら means if AND when, and Japanese never makes you pick between them. Then the one form it has to be told apart from: と, which claims the result happens EVERY time — seasons, machines, and the directions somebody gives you in the street. The difference is not a feel. Look at the end of the sentence: if it is a request, an invitation or a plan, と is blocked and たら is the answer. Along the way you get the politest suggestion in the language, and how to say roughly when and roughly how long.",
          tier: "n4",
          lessons: [
            { id: "ja-m32-neo-1", title: "「あめが ふったら」 — the past form, plus ら", status: "available" as const },
            { id: "ja-m32-neo-2", title: "「はるに なったら」 — if and when are the same word", status: "available" as const },
            { id: "ja-m32-neo-3", title: "「ついたら、でんわを して ください」 — たら takes any ending", status: "available" as const },
            { id: "ja-m32-neo-review-1", title: "Review — one form, three jobs", status: "available" as const },
            { id: "ja-m32-neo-5", title: "「ボタンを おすと」 — the result that never varies", status: "available" as const },
            { id: "ja-m32-neo-6", title: "「まっすぐ いくと、えきが ある」 — asking the way", status: "available" as const },
            { id: "ja-m32-neo-7", title: "「ついたら、でんわを して ください」 — what と cannot say", status: "available" as const },
            { id: "ja-m32-neo-review-2", title: "Review — every time, or just this time?", status: "available" as const },
            { id: "ja-m32-neo-9", title: "「いしゃに いったら どうですか」 — suggesting without telling", status: "available" as const },
            { id: "ja-m32-neo-10", title: "「さんじごろ」と「さんじかんぐらい」 — about, and around", status: "available" as const },
            { id: "ja-m32-neo-11", title: "たら と と — the same two events, two different claims", status: "available" as const },
            { id: "ja-m32-neo-review-3", title: "Review — conditions, suggestions and roughly how long", status: "available" as const },
            { id: "ja-m32-neo-challenge", title: "Challenge — directions, machines and a plan for the weekend", status: "available" as const },
            // Moved off the m17 tile with the story itself: its direction
            // vocabulary is taught here, not there (see stories.ts).
        ...
        },
        {
          ...
          eyebrow: "Module 34 · JLPT N4",
          summary: "You already own more of this than it looks like: のみましょう has been yours since module 24, and it turns out that was always the polite dress on a plainer word — のもう. This module hands you that plainer word for every verb you know, then puts it to work — inviting a friend, deciding to quit a job, admitting an attempt fell short, setting a goal for the year ahead. Two real conversations carry it, so the same suggestion lands casual with a friend and polite with a teacher, on purpose.",
          tier: "n4",
          lessons: [
            { id: "ja-m34-neo-1", title: "「のもう」 — the will behind ましょう", status: "available" as const },
            { id: "ja-m34-neo-2", title: "「たべよう・しよう・こよう」 — the ru-verbs and the two you memorise", status: "available" as const },
            { id: "ja-m34-neo-3", title: "「いこう？」 — the plainest invitation there is", status: "available" as const },
            { id: "ja-m34-neo-review-1", title: "Review — your will, in both registers", status: "available" as const },
            { id: "ja-m34-neo-5", title: "「さがそうとおもう」 — intent, held at arm's length", status: "available" as const },
            { id: "ja-m34-neo-6", title: "「やめることにした」 — deciding, hands on the wheel", status: "available" as const },
            { id: "ja-m34-neo-7", title: "「けっこんすることになった」 — when the decision arrives", status: "available" as const },
            { id: "ja-m34-neo-review-2", title: "Review — will, intent, and decisions", status: "available" as const },
            { id: "ja-m34-neo-9", title: "「あけようとしたけど、あかなかった」 — the attempt itself", status: "available" as const },
            { id: "ja-m34-neo-10", title: "「がんばろう」 — goals, and the polite room", status: "available" as const },
            { id: "ja-m34-neo-review-3", title: "Review — everything the will can do", status: "available" as const },
            { id: "ja-m34-neo-challenge", title: "Challenge — the year ahead", status: "available" as const },
          ],
          accent: { from: "#10b981", to: "#047857" },
        },
        {
          id: "m35",
          title: "Give & receive II — てあげる/てくれる/てもらう + favors",
          eyebrow: "Module 35 · JLPT N4",
          summary: "No new rule this time — module 30's て + helper slot, with module 31's giving verbs parked in it, drilled until it's reflex. せんせいが おしえてくれた reports a kindness that landed on you; ともだちに てつだってもらった tells the same help from your own end. The trap worth knowing: offering upward with あげる — せんせいを てつだってあげます — is grammatically perfect and socially wrong, so this module teaches the mistake on purpose before handing you the real move, てつだいましょうか. Then the whole favor-asking ladder, casual て/てくれる？/てくれない？ up through polite てくれませんか/てもらえますか, assembled for real for the first time.",
          tier: "n4",
          lessons: [
            { id: "ja-m35-neo-1", title: "「おしえてくれた」 — help that lands on you", status: "available" as const },
            { id: "ja-m35-neo-2", title: "「かってあげた」 — and the trap in pointing it upward", status: "available" as const },
            { id: "ja-m35-neo-3", title: "「てつだってもらった」 — the same help, told from your end", status: "available" as const },
            { id: "ja-m35-neo-review-1", title: "Review — three verbs, one event", status: "available" as const },
            { id: "ja-m35-neo-5", title: "「はこんでくれない？」 — asking, the friendly way", status: "available" as const },
            { id: "ja-m35-neo-6", title: "「とってもらえますか」 — asking, the polite way", status: "available" as const },
            { id: "ja-m35-neo-7", title: "「ケンだけ」と「ひとりしか いない」 — just, and only", status: "available" as const },
            { id: "ja-m35-neo-review-2", title: "Review — the ladder so far, and the limits", status: "available" as const },
            { id: "ja-m35-neo-9", title: "「えきまで むかえに きてくれる？」 — favors in motion", status: "available" as const },
            { id: "ja-m35-neo-10", title: "「てつだいましょうか」 — offering, without the trap", status: "available" as const },
            { id: "ja-m35-neo-review-3", title: "Review — the whole ladder, assembled", status: "available" as const },
            { id: "ja-m35-neo-challenge", title: "Challenge — the favor economy", status: "available" as const },
          ],
          accent: { from: "#8b5cf6", to: "#6d28d9" },
        },
        {
          id: "m36",
          title: "Looks like — そう, がる, やすい/にくい, ながら",
          eyebrow: "Module 36 · JLPT N4",
          summary: "One seam, four attachments, all riding the same stem you've owned since module 7. おいしそう isn't the food tasting good — it's how it LOOKS before the first bite, and そう lives exactly in that gap between what your eyes report and what you actually know, on adjectives (かたそう, looks tough) and on verbs about to happen (ふりそう, about to rain) alike. Then the door N5 locked shut on purpose: you could always say what YOU want, never what somebody else does. おとうとは いきたがっている finally opens it — がる turns a private feeling into a visible behavior instead of pretending to read minds. Two more ride the same stem: やすい/にくい turns any verb into its own difficulty rating, and ながら lets one person do two things at once. A dinner at Mika's puts the whole gap to work — you say what looks good before you know if it is.",
          tier: "n4",
          lessons: [
            { id: "ja-m36-neo-1", title: "「おいしそう」 — what the eye reports", status: "available" as const },
            { id: "ja-m36-neo-2", title: "「ふりそう」 — an event leaning forward", status: "available" as const },
            { id: "ja-m36-neo-3", title: "「おいしそう！」 — saying it at the table", status: "available" as const },
            { id: "ja-m36-neo-review-1", title: "Review — looks, on both word classes", status: "available" as const },
            { id: "ja-m36-neo-5", title: "「いきたがっている」 — reading other minds", status: "available" as const },
            { id: "ja-m36-neo-6", title: "「つかいやすい」 — adjectives you build yourself", status: "available" as const },
            { id: "ja-m36-neo-7", title: "「ききながら」 — two things, one person", status: "available" as const },
            { id: "ja-m36-neo-review-2", title: "Review — one stem, four attachments", status: "available" as const },
            { id: "ja-m36-neo-9", title: "「こわがっている」 — the feeling and the showing", status: "available" as const },
            { id: "ja-m36-neo-10", title: "「ふりそうだから、うちで みよう」 — reading the sky", status: "available" as const },
            { id: "ja-m36-neo-review-3", title: "Review — the whole attachment site", status: "available" as const },
            { id: "ja-m36-neo-challenge", title: "Challenge — a day read off the surface of things", status: "available" as const },
          ],
        ...
        },
        {
          ...
          eyebrow: "Module 37 · JLPT N4",
          summary: "The stem grid pays out a third time: slide the u-row to the e-row and add ば — いけば, のめば, まにあえば — and every i-adjective follows the same くない/かった pattern into ければ. Then the reveal: いかなければ, the obligation you've produced since module 28, was never a frozen block. Unfreeze it and it's just ない bent into its own ば-form — the course's third ました-was-た move. ば has one wall (an action-verb ば-clause can't carry a request — ×たべれば、かってください) and one exemption lived in a weekend plan, てんきが よければ、いこう. Then なら, the conditional that listens: it picks up what was just said and advises on it, which is why にほんに いくなら、きっぷを かっておいた ほうが いい can buy the ticket BEFORE the trip — the only conditional whose answer runs ahead of its condition. Two pairwise contrasts, never three-way: ば vs たら, then なら vs たら, kept strictly apart the way は/が were.",
          tier: "n4",
          lessons: [
            { id: "ja-m37-neo-1", title: "「いけば、わかる」 — the third payout of the stem grid", status: "available" as const },
            { id: "ja-m37-neo-2", title: "「たべれば・すれば・くれば」 — the grid closes", status: "available" as const },
            { id: "ja-m37-neo-3", title: "「たべたら、かってください」 — ば's one wall, and たら's open door", status: "available" as const },
            { id: "ja-m37-neo-review-1", title: "Review — the if you build off the stem", status: "available" as const },
            { id: "ja-m37-neo-5", title: "「てんきが よければ、いこう」 — the if in real plans", status: "available" as const },
            { id: "ja-m37-neo-6", title: "「いくなら、かっておいた ほうが いい」 — the conditional that listens", status: "available" as const },
            { id: "ja-m37-neo-7", title: "「いくなら かっておく・いったら かう」 — time runs both ways", status: "available" as const },
            { id: "ja-m37-neo-review-2", title: "Review — three ifs, two pairs", status: "available" as const },
            { id: "ja-m37-neo-9", title: "「やすければ やすいほど、いい」 — the shape that dials", status: "available" as const },
            { id: "ja-m37-neo-10", title: "「いくなら、よやくした ほうが いい」 — advice, assembled", status: "available" as const },
            { id: "ja-m37-neo-review-3", title: "Review — every if, in its place", status: "available" as const },
            { id: "ja-m37-neo-challenge", title: "Challenge — the trip that plans itself", status: "available" as const },
          ],
        ...
        },
        {
          ...
          eyebrow: "Module 38 · JLPT N4",
          summary: "The second helper beat, eight modules after module 30's て + みる/おく — and it opens on the same slot, sixty seconds of rehash before the new resident. しまう behind a て-form wears down to COMPLETELY, and the whole lesson orbits one pair on the SAME verb: ぜんぶ たべてしまった at your own dinner is pride, every bite gone; ともだちの ケーキを たべてしまった is the identical form and it winces — the tell was never the grammar, only what got eaten. Casual speech contracts it to ちゃう/じゃう, drilled as production because that's what your friends actually say back, and it hosts a confession scene: こわしちゃった owns the broken umbrella, こわれちゃった dodges it. Then the trajectory system you've owned since module 19 gets a て behind it: もっていく takes a thing away, もってくる brings it here, つれる does the same job for people — a party-errand sim runs the exchange from both ends, なにを もってくる？ answered with のみものを もっていく, one journey, two anchors. A second read on てくる/ていく trades motion for time: ふえてきた is a rise you've been watching arrive, かわっていく is change still heading on.",
          tier: "n4",
          lessons: [
            { id: "ja-m38-neo-1", title: "「ぜんぶ たべてしまった」 — done, through, all of it", status: "available" as const },
            { id: "ja-m38-neo-2", title: "「なくしてしまった」 — the same form, wincing", status: "available" as const },
            { id: "ja-m38-neo-3", title: "「なくしちゃった」 — what people actually say", status: "available" as const },
            { id: "ja-m38-neo-review-1", title: "Review — done, and gone and done", status: "available" as const },
            { id: "ja-m38-neo-5", title: "「もっていく・もってくる」 — take, and bring", status: "available" as const },
            { id: "ja-m38-neo-6", title: "「つれてきて」 — people come along, and きて stays きて", status: "available" as const },
            { id: "ja-m38-neo-7", title: "「さむく なってきた」 — change, arriving and leaving", status: "available" as const },
            { id: "ja-m38-neo-review-2", title: "Review — three helpers, one slot", status: "available" as const },
            { id: "ja-m38-neo-9", title: "「かんじに なれてきた」 — your own arc, in grammar", status: "available" as const },
            { id: "ja-m38-neo-10", title: "「なにを もっていく？」 — the party runs on trajectories", status: "available" as const },
            { id: "ja-m38-neo-review-3", title: "Review — everything the slot can hold", status: "available" as const },
            { id: "ja-m38-neo-challenge", title: "Challenge — the day that went wrong, and came right", status: "available" as const },
          ],
          accent: { from: "#0ea5e9", to: "#0369a1" },
        },
        {
          id: "m39",
          title: "Concession & reasons — のに vs ので, ても/でも, し",
          eyebrow: "Module 39 · JLPT N4",
          summary: "のに is ので's minimal pair — the exact same joint, plain form and な before a noun or な-adjective, and exactly the opposite job. ので states a reason as flat fact; のに insists on a CLASH, and it never leaves the room emotionally neutral: たかいのに かった carries a shrug, and ねつが あるのに がっこうに いった is a straight-up complaint. ても widens the same idea to hypotheticals and generalities — たかくても かう holds a plan steady no matter what happens, resolve instead of regret — and でも does the identical job for nouns and な-adjectives that have no て-form to lean on. A closed set of five, なんでも/だれでも/どこでも/だれも/なにも, gets memorized whole rather than derived. Last in: し stacks reasons the way English 'and, what's more' does, piling やすいし、おいしいし toward one conclusion. A production lesson pins のに against ので on matched near-pairs by the swap-test — does 'even though' fit, or 'because'? — and a final sim runs ても and し together across one exchange, the errand that won't wait.",
          tier: "n4",
          lessons: [
            { id: "ja-m39-neo-1", title: "「たかいのに かった」 — spending anyway", status: "available" as const },
            { id: "ja-m39-neo-2", title: "「ねつが あるのに がっこうに いった」 — the complaint that goes anyway", status: "available" as const },
            { id: "ja-m39-neo-3", title: "「たかくても かう」 — resolve, not reason", status: "available" as const },
            { id: "ja-m39-neo-review-1", title: "Review — say it happened anyway", status: "available" as const },
            { id: "ja-m39-neo-5", title: "「がくせいでも わかる」 — even, on a noun", status: "available" as const },
            { id: "ja-m39-neo-6", title: "「だれでも わかる」 — the closed set", status: "available" as const },
            { id: "ja-m39-neo-7", title: "「やすいし、おいしいし」 — reasons, piling up", status: "available" as const },
            { id: "ja-m39-neo-review-2", title: "Review — even, and what's more", status: "available" as const },
            { id: "ja-m39-neo-9", title: "「のに か ので か」 — telling the twins apart", status: "available" as const },
            { id: "ja-m39-neo-10", title: "「つかれても、いくし」 — the errand that won't wait", status: "available" as const },
            { id: "ja-m39-neo-review-3", title: "Review — every reason, every concession", status: "available" as const },
            { id: "ja-m39-neo-challenge", title: "Challenge — the day nothing went to plan", status: "available" as const },
          ],
        ...
        },
        {
          ...
          eyebrow: "Module 40 · JLPT N4",
          summary: "The direct passive turns the sentence around: the one something happens TO becomes topic, and the doer takes に — せんせいに ほめられた, I was praised by the teacher, sitting deliberately beside がくせいは せんせいに しかられた, the student was scolded, so the grammar itself never reads as inherently bad news. Formation splits cleanly: godan bends to its a-stem (ぬすむ → ぬすまれる), ichidan drops る (ほめる → ほめられる), irregulars are memorized whole (する → される). When what's affected is something OWNED, the owner becomes topic and the owned thing keeps を — どろぼうに さいふを ぬすまれた, the opposite promotion English makes. によって steps in as the formal cousin of に for who MADE something (この きかいは タナカさんに よって はつめいされた), and a recognition-only closing beat meets 迷惑の受身, the suffering passive that marks a speaker was inconvenienced with no English passive to match (あめに ふられた — I got rained on).",
          tier: "n4",
          lessons: [
            { id: "ja-m40-neo-1", title: "「どろぼうが いる」 — the cast for this arc", status: "available" as const },
            { id: "ja-m40-neo-2", title: "「せんせいに ほめられた」 — the passive, both classes at once", status: "available" as const },
            { id: "ja-m40-neo-3", title: "「どろぼうに さいふを ぬすまれた」 — when it's yours that's taken", status: "available" as const },
            { id: "ja-m40-neo-review-1", title: "Review — who did it to whom", status: "available" as const },
            { id: "ja-m40-neo-5", title: "「タナカさんに よって はつめいされた」 — who made it", status: "available" as const },
            { id: "ja-m40-neo-6", title: "「あめに ふられた」 — the passive that isn't about you doing anything", status: "available" as const },
            { id: "ja-m40-neo-7", title: "「ひがいが あった」 — discrimination: に、によって、を", status: "available" as const },
            { id: "ja-m40-neo-review-2", title: "Review — every agent marker so far", status: "available" as const },
            { id: "ja-m40-neo-9", title: "「ほめられたし、たのまれたし」 — combining passive with what you already own", status: "available" as const },
            { id: "ja-m40-neo-10", title: "「たてられたし、けんきゅうされた」 — every passive, one last time", status: "available" as const },
            { id: "ja-m40-neo-review-3", title: "Review — every passive, every marker", status: "available" as const },
            { id: "ja-m40-neo-challenge", title: "Challenge — the day the police came", status: "available" as const },
          ],
        ...
        },
        {
          ...
          eyebrow: "Module 41 · JLPT N4",
          summary: "てある rides the exact て-form slot ておく and ている already occupy: a TRANSITIVE verb's て-form + ある names a state someone left behind on purpose, and the object drops を for が — まどを あける, an action, becomes まどが あけてある, the window has been left open (on purpose). Set against 自動詞+ている (a state with no agent named) and 他動詞+ている (the same verb, actually happening right now), and against ておく (which keeps the agent on stage, を, versus てある's が), then run through a tenth jidoushi/tadoushi pair — ならぶ／ならべる — joining the nine module 33 already taught.",
          tier: "n4",
          lessons: [
            { id: "ja-m41-neo-1", title: "「かべに ポスターが ある」 — getting the room's vocabulary", status: "available" as const },
            { id: "ja-m41-neo-2", title: "「ポスターが はってある」 — てある, a result someone meant", status: "available" as const },
            { id: "ja-m41-neo-3", title: "「あいている・あけている・あけてある」 — three shapes, three readings", status: "available" as const },
            { id: "ja-m41-neo-review-1", title: "Review — てある so far", status: "available" as const },
            { id: "ja-m41-neo-5", title: "「あけておく」 vs 「あけてある」 — what I'll do vs what's already so", status: "available" as const },
            { id: "ja-m41-neo-6", title: "「ならんでいる」 「ならべてある」 — the tenth pair", status: "available" as const },
            { id: "ja-m41-neo-7", title: "「はってあるし、ならべてあるし」 — production sweep across every face", status: "available" as const },
            { id: "ja-m41-neo-review-2", title: "Review — every face of てある, every pair", status: "available" as const },
            { id: "ja-m41-neo-9", title: "「かざってあるし、ならべてあるし」 — production capstone", status: "available" as const },
            { id: "ja-m41-neo-10", title: "「あけてあるし、ならべてある」 — every face, one last time", status: "available" as const },
            { id: "ja-m41-neo-review-3", title: "Review — the whole module, every marker", status: "available" as const },
            { id: "ja-m41-neo-challenge", title: "Challenge — the room before the party", status: "available" as const },
          ],
          accent: { from: "#6366f1", to: "#4338ca" },
        },
        {
          id: "m42",
          title: "Hearsay: 〜そうだ, 〜って, 〜らしい",
          eyebrow: "Module 42 · JLPT N4",
          summary: "Three ways to say you heard something, kept deliberately separate. そうだ reports a direct source — a full plain-form sentence plus そうだ, あめが ふるそうだ, 'I heard it's going to rain.' って is そうだ's casual quoting shortcut, たなかさんが くるって, 'Tanaka said he's coming' — friends only, never teachers. と言っていた extends that same quoting into the past with the register-neutral と already yours from module 18, きしゃは じこが あったと いっていた, 'the reporter said there was an accident.' らしい steps back one level further — an impression from indirect evidence, not a source you can point to — きしゃは びょうきらしい, 'apparently the reporter is sick,' with no だ before a noun, unlike そうだ. All three interleave across a shared news-and-disaster domain, never taught as one labeled three-way table.",
          tier: "n4",
          lessons: [
            { id: "ja-m42-neo-1", title: "「じしんが あった」— the news and weather domain", status: "available" as const },
            { id: "ja-m42-neo-2", title: "「あめが ふるそうだ」— そうだ, what you heard", status: "available" as const },
            { id: "ja-m42-neo-3", title: "「くるって」— って, casual reported speech", status: "available" as const },
            { id: "ja-m42-neo-review-1", title: "Review — そうだ and って", status: "available" as const },
            { id: "ja-m42-neo-4", title: "「くると いっていた」— と言っていた, reported past", status: "available" as const },
            { id: "ja-m42-neo-5", title: "「ほうそうで はっぴょうした」— domain build: news and disaster reporting", status: "available" as const },
            { id: "ja-m42-neo-6", title: "「たいふうが くるらしい」— らしい, hearsay from indirect evidence", status: "available" as const },
            { id: "ja-m42-neo-review-2", title: "Review — そうだ, と言っていた, らしい", status: "available" as const },
            { id: "ja-m42-neo-7", title: "「そうだって、らしいって、みんな いろいろ いっている」— mixed sources, one conversation", status: "available" as const },
            { id: "ja-m42-neo-8", title: "「けいほうは まだ ないらしいけど」— pre-review integration", status: "available" as const },
            { id: "ja-m42-neo-review-3", title: "Review — the whole module, every marker", status: "available" as const },
            { id: "ja-m42-neo-challenge", title: "Challenge — three ways to say you heard", status: "available" as const },
          ],
          accent: { from: "#eab308", to: "#a16207" },
        },
        {
          id: "m43",
          title: "Certainty ladder: 〜かもしれない / 〜はず / でしょう-deepen",
          eyebrow: "Module 43 · JLPT N4",
          summary: "Four rungs of how sure you sound, never merged into one table. かもしれない admits genuine uncertainty — plain form + かもしれない, but a noun or な-adjective drops だ first, がくせいかもしれない, 'might be a student.' はず claims a real reason backs your conclusion — the opposite connector move, inserting の or な instead, がくせいのはずだ, 'she should be a student.' はずだった reports a broken expectation and はずがない flatly denies. でしょう gets a quick deepening pass across all three hosts, だろう staying strictly recognition-only as always. A closing certainty-ladder card orders all four — にちがいない (recognition only) > はず > でしょう/だろう > かもしれない — over a promises-and-plans domain.",
          tier: "n4",
          lessons: [
            { id: "ja-m43-neo-1", title: "「やくそくが ある」— the promises and plans domain", status: "available" as const },
            { id: "ja-m43-neo-2", title: "「ふるかもしれない」— かもしれない, admitting a guess", status: "available" as const },
            { id: "ja-m43-neo-3", title: "「むずかしいでしょう」— でしょう-deepen", status: "available" as const },
            { id: "ja-m43-neo-review-1", title: "Review — かもしれない and でしょう-deepen", status: "available" as const },
            { id: "ja-m43-neo-4", title: "「くるはずだ」— はず, a confident conclusion", status: "available" as const },
            { id: "ja-m43-neo-5", title: "「くるはずだったが」— はずだった / はずがない, production spends", status: "available" as const },
            { id: "ja-m43-neo-6", title: "「しんじれば あんしんだ」— domain integration + a recognition aside", status: "available" as const },
            { id: "ja-m43-neo-review-2", title: "Review — かもしれない, でしょう-deepen, and はず", status: "available" as const },
            { id: "ja-m43-neo-7", title: "「くるかもしれないが、くるはずだ」— mixed certainty, one conversation", status: "available" as const },
            { id: "ja-m43-neo-8", title: "「はずと でしょうと かもしれない」— assembling the certainty ladder", status: "available" as const },
            { id: "ja-m43-neo-review-3", title: "Review — the whole module, every rung of the ladder", status: "available" as const },
            { id: "ja-m43-neo-challenge", title: "Challenge — the whole certainty ladder, one conversation", status: "available" as const },
          ],
          accent: { from: "#0ea5e9", to: "#0369a1" },
        },
        {
          id: "m44",
          title: "Evidential-family reassembly: ようだ / みたい / のように・のような",
          eyebrow: "Module 44 · JLPT N4",
          summary: "One root よう, four jobs, organized by SOURCE of evidence rather than strength. ようだ states a direct-evidence guess grounded in something you just saw, heard, smelled, or tasted — plain form + ようだ, but a noun or な-adjective host takes の first, こどものようだ, 'seems like a child.' みたい is ようだ's exact casual twin, same evidence rule, but a noun host attaches bare — こどもみたいだ, no の. のように steps outside guessing entirely to describe HOW something is by simile, and のような describes WHAT something is, the same simile in front of a noun — both always keep の, no exception. A closing evidential-family card sorts all four by what kind of evidence backs them, never confused with m43's certainty ladder (strength, not source) or m42's そうだ (hearsay, not direct evidence) — over a sensory-and-resemblance domain (smells, tastes, mirrors, dolls, atmosphere).",
          tier: "n4",
          lessons: [
            { id: "ja-m44-neo-1", title: "「けむりの におい」— the sensory-evidence domain", status: "available" as const },
            { id: "ja-m44-neo-2", title: "「かぜを ひいたようだ」— ようだ, a direct-evidence guess", status: "available" as const },
            { id: "ja-m44-neo-3", title: "「げんきなようだ」— ようだ off a noun or な-adjective", status: "available" as const },
            { id: "ja-m44-neo-review-1", title: "Review — ようだ, direct evidence off every host", status: "available" as const },
            { id: "ja-m44-neo-5", title: "「かぜを ひいたみたい」— みたい, the casual twin", status: "available" as const },
            { id: "ja-m44-neo-6", title: "「こおりのように つめたい」— のように, a simile of HOW", status: "available" as const },
            { id: "ja-m44-neo-7", title: "「にんぎょうのような かお」— のような + the resemblance domain", status: "available" as const },
            { id: "ja-m44-neo-review-2", title: "Review — ようだ, みたい, and のように・のような", status: "available" as const },
            { id: "ja-m44-neo-9", title: "「あめが ふる きざし」— atmosphere and signs, domain integration", status: "available" as const },
            { id: "ja-m44-neo-10", title: "「ようだと みたいと のようにと のような」— assembling the evidential family", status: "available" as const },
            { id: "ja-m44-neo-review-3", title: "Review — the whole module, every shape of the evidential family", status: "available" as const },
            { id: "ja-m44-neo-challenge", title: "Challenge — the whole evidential family, one conversation", status: "available" as const },
          ],
          accent: { from: "#8b5cf6", to: "#6d28d9" },
        },
        {
          id: "m45",
          title: "Causative させる: make/let someone do",
          eyebrow: "Module 45 · JLPT N4",
          summary: "Two formation classes — godan bends to its a-row and adds せる (よむ→よませる), ichidan drops る and adds させる whole (たべる→たべさせる), with する→させる and くる→こさせる memorized outright. The causative verb never says MAKE vs LET by itself: for an intransitive verb the causee's particle carries the whole signal (こどもを あるかせた = made walk, こどもに あるかせた = let walk); for a transitive verb the causee is fixed at に, so MAKE vs LET reads from context and adverbs like むりやり instead. Closes with the request ladder — させて ください to ask permission for yourself, させて もらう to describe receiving it — and a RECOGNITION-ONLY look at させて いただく, the humble twin whose production (and causative-passive させられる) waits for keigo at n4-21.",
          tier: "n4",
          lessons: [
            { id: "ja-m45-neo-1", title: "「おやは こどもに ほんを よませる」— させる, the godan causative", status: "available" as const },
            { id: "ja-m45-neo-2", title: "「しかたが ない」— interleave break, before the second causative class", status: "available" as const },
            { id: "ja-m45-neo-3", title: "「おやは こどもに やさいを たべさせる」— させる, ichidan and the irregulars", status: "available" as const },
            { id: "ja-m45-neo-review-1", title: "Review — させる, both formation classes", status: "available" as const },
            { id: "ja-m45-neo-4", title: "「こどもを あるかせた」「こどもに あるかせた」— MAKE vs LET, intransitive", status: "available" as const },
            { id: "ja-m45-neo-5", title: "「せんせいに しかられた」— passive comes back, spiral", status: "available" as const },
            { id: "ja-m45-neo-6", title: "「こどもに いぬを そだてさせる」— MAKE vs LET, transitive", status: "available" as const },
            { id: "ja-m45-neo-review-2", title: "Review — MAKE vs LET, intransitive and transitive", status: "available" as const },
            { id: "ja-m45-neo-7", title: "「しゅくだいを させて ください」— させる, the request ladder", status: "available" as const },
            { id: "ja-m45-neo-8", title: "「しゅくだいを させて いただく」— recognize the ultra-polite twin", status: "available" as const },
            { id: "ja-m45-neo-review-3", title: "Review — the request ladder and させて いただく recognition", status: "available" as const },
            { id: "ja-m45-neo-challenge", title: "Challenge — させる, every shape in one arc", status: "available" as const },
          ],
          accent: { from: "#f97316", to: "#c2410c" },
        },
        {
          ...
          eyebrow: "Module 46 · JLPT N4",
          summary: "One mechanism — a timing/aspect frame riding a noun or verb-form host — spent across four hosts. あいだ marks a whole span, あいだに (に is the entire signal) narrows it to one point inside that span. うちに widens the already-known うち ('home', m16) into 'within a state's own window' — act before it closes. ところだ rides a verb's own tense (dictionary/ている/た) to pin exactly where you are in an action — about to start, mid-action, or just finished. A quantity-drip break threads ばかり ('nothing but X'), ずつ ('X at a time'), and め (ordinals off counted numbers) through the middle. Closes with a compound-verb trio — はじめる／つづける／おわる fused onto a masu-stem for 'start/keep/finish doing X' — and two capstone discriminations: たばかり (recency) vs たところ (sequence-position), and まま, the stative cousin of て-おく／て-ある that names a state left untouched.",
          tier: "n4",
          lessons: [
            { id: "ja-m46-neo-1", title: "「はなしている あいだ」「あいだに」— a whole span vs one point inside it", status: "available" as const },
            { id: "ja-m46-neo-2", title: "「がっこうへ いく とちゅうで」— とちゅう, interleave break", status: "available" as const },
            { id: "ja-m46-neo-3", title: "「あつい うちに たべる」— うちに, a closing window", status: "available" as const },
            { id: "ja-m46-neo-review-1", title: "Review — あいだ, あいだに, うちに", status: "available" as const },
            { id: "ja-m46-neo-4", title: "「たべる／たべている／たべた ところだ」— ところだ's three tenses", status: "available" as const },
            { id: "ja-m46-neo-5", title: "「ごはんばかり」「ひとつずつ」「ふたつめ」— quantity drip: ばかり・ずつ・め", status: "available" as const },
            { id: "ja-m46-neo-6", title: "「たべはじめる」「よみつづける」— compound verbs, start/keep doing X", status: "available" as const },
            { id: "ja-m46-neo-review-2", title: "Review — ところだ and the compound-verb pair", status: "available" as const },
            { id: "ja-m46-neo-7", title: "「かったばかりだ」「たべた ところだ」— たばかり vs たところ", status: "available" as const },
            { id: "ja-m46-neo-8", title: "「そのまま」「たべおわる」— まま, and finishing with おわる", status: "available" as const },
            { id: "ja-m46-neo-review-3", title: "Review — the whole module, every timing and aspect frame", status: "available" as const },
            { id: "ja-m46-neo-challenge", title: "Challenge — あいだに, おわる, and まま in one arc", status: "available" as const },
          ],
          accent: { from: "#14b8a6", to: "#0d9488" },
        },
      ],
