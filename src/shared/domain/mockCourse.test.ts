...
describe("curriculum lesson counts", () => {
  ...
  it("m20-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // (2026-07-27, tile n07), m18 (2026-07-27, tile n08) and m19 (2026-07-27,
    // tile s15) are authored via the compiler pipeline. The frontier advances
    // as rewrite cycles land modules.
    for (let n = 20; n <= 29; n++) {
