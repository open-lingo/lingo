...
describe("curriculum lesson counts", () => {
  ...
  it("m23-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // tile s15), m20 (2026-07-27, tile n09), m21 (2026-07-27, tile s19) and
    // m22 (2026-07-27, tile s17) are authored via the compiler pipeline. The
