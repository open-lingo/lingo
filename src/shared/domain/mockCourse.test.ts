...
describe("curriculum lesson counts", () => {
  ...
  it("m17-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    // m4/m5/m6 (2026-07-20), m7-m11 (2026-07-26, the first modules on the
    // 11+3+1 shape), m12 (tile s09), m13 (tile n05), m14 (2026-07-27, tile
    // n06b), m15 (2026-07-27, tile s11) and m16 (2026-07-27, tile s13) are
    // authored via the compiler pipeline. The frontier advances as rewrite
    // cycles land modules.
    for (let n = 17; n <= 29; n++) {
