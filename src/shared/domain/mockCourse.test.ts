...
describe("curriculum lesson counts", () => {
  ...
  it("m22-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // tile s15), m20 (2026-07-27, tile n09) and m21 (2026-07-27, tile s19)
    // are authored via the compiler pipeline. The frontier advances as
