...
describe("curriculum lesson counts", () => {
  ...
  it("m27-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // (2026-07-27, tile s21), m25 (2026-07-27, tile n13) and m26
    // (2026-07-27, tile n14) are authored via the compiler pipeline. The
