...
describe("curriculum lesson counts", () => {
  ...
  it("m25-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // m22 (2026-07-27, tile s17), m23 (2026-07-27, tile s22) and m24
    // (2026-07-27, tile s21) are authored via the compiler pipeline. The
