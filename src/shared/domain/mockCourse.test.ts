...
describe("curriculum lesson counts", () => {
  ...
  it("m26-m29 are comingSoon spine placeholders (visible, zero lessons)", () => {
    ...
    // (2026-07-27, tile s21) and m25 (2026-07-27, tile n13) are authored via
    // the compiler pipeline. The frontier advances as rewrite cycles land
    // modules.
    for (let n = 26; n <= 29; n++) {
