...
export const LANGUAGE_CONFIGS: Record<string, LanguageConfig> = {
  ko: {
    ...
    name: "Korean",
    flag: "🇰🇷",
    backgroundImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/View_of_Seoul.jpg/1280px-View_of_Seoul.jpg",
  ...
  ja: {
    ...
    name: "Japanese",
    flag: "🇯🇵",
    backgroundImage: "https://upload.wikimedia.org/wikipedia/commons/7/71/12-Chureito-pagoda-and-Mount-Fuji-Japan_%2829677439878%29.jpg",
