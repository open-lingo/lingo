...
// `JA_KANA_EMOJI_MAP` / `lookupKanaEmoji` (course-atom-derived) moved to
// `./kanaEmojiMap` — that's the only part of this module that needs the
// full JA course-atom table, and most callers here (e.g. the language
// switcher, via `notoFlagUrl`) don't need it at all.
