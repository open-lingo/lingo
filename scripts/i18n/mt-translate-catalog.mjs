...
CONVENTIONS (docs/ko-content-conventions-2026-09-10.md — follow exactly):
  ...
  - DIGIT+COUNTER SPACING: fuse an Arabic-numeral digit directly onto its counter — NO space — for 시/분/월/일/살/개/장/명/번/층/과 and similar counters (9시부터 5시까지, 3월, 5개, 2명); a native-Korean spelled-out numeral word still takes a space before its counter (두 장, 세 명 stay spaced). Confirmed drift class: the m16 draft wrote "9 시부터 5 시까지" (spaced) — 39 of 103 review fixes were this one pattern.
