...
CONVENTIONS (docs/ko-content-conventions-2026-09-10.md — follow exactly):
  ...
  - CUE REGISTER (친구에게 말하세요:): the remainder of a pinned "친구에게 말하세요:" cue renders spoken 해체 (반말: 안 가 / 그래 / 몰라), NEVER the written plain form -는다/-ㄴ다 and NEVER 합니다체 — e.g. remainder "I don't know" → 몰라, not 모른다 or 모릅니다.
