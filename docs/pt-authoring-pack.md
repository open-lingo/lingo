...
- `allow:` closed set: {e, ou, mas, não, sim, com, a, o, muito, porque, também, só} — anything else must be a real atom, EXCEPT a capitalized token (a proper noun: São, Paulo, Rio, Bia…), which is always exempt.
