...
| Per-pack learner-sim walks (QA verdicts) | `learner-sim/m11-packs-2026-07-29.md`, `learner-sim/m13-m14-packs-2026-07-29.md` — the pack-wave QA loop: BLOCKER→B074 engine guard, recognition-gap class→`recognitionExposure.test.ts` ratchet (rule 3, binding). m16 packs' walk still owed |
