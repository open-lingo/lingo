...
- getRawMockLesson (function)
- GetLessonContentOptions (type)
...
### src/shared/assets/kanaEmojiMap.ts
...
### src/features/lesson/data/contentLoader.ts
- ContentModuleEntry (type)
- ContentLanguageEntry (type)
- ContentManifest (type)
- CONTENT_ROOT (const)
- contentUrl (function)
- getLoadedContentManifest (function)
- loadContentManifest (function)
- isContentFileLoaded (function)
- ensureModuleLoaded (function)
- ensureCourseLoaded (function)
...
- RecycleSummary (type)
- summarize (function)
- classSlotSkeleton (function)
- ADDITIVE_GRAMMAR_IDS (const)
- ADDITIVE_TITLE_RE (const)
- isAdditiveLesson (function)
...
- PlainText (function)
### src/shared/i18n/content/anchors.ts
- hasJaScript (function)
- courseIdsFromLessonId (function)
- hintAnchor (function)
- explanationAnchor (function)
- promptAnchor (function)
- bodyAnchor (function)
- cultureNoteAnchor (function)
- titleAnchor (function)
- optionAnchor (function)
- pairTargetAnchor (function)
- grammarRuleAnchor (function)
- grammarExampleAnchor (function)
- grammarAntipatternWhyAnchor (function)
- atomGlossAnchor (function)
- atomShortGlossAnchor (function)
- symbolIntroHintAnchor (function)
- storyTitleAnchor (function)
- storyThemeAnchor (function)
- storySentenceAnchor (function)
- storyGlossAnchor (function)
...
- MinedSentenceIndexes (type)
- computeMinedSentenceIndexes (function)
- setMinedSentenceIndexes (function)
...
- mulberry32 (function)
### src/features/lesson/data/minedLessonReader.ts
- MinedLessonReader (type)
- setMinedLessonReader (function)
- getMinedLessonReader (function)
...
### src/features/lesson/hooks/useContentString.ts
- useContentString (function)
- useContentStrings (function)
...
### src/features/languages/fr/placementBank.ts
- collectFrPlacement (function)
- FR_PLACEMENT_BANK (const)
...
### src/shared/i18n/content/resolveContentString.ts
- resolveContentStringFromCatalogs (function)
- resolveContentString (function)
