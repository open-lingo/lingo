...
| T18 | ≥12-tile answers at 125 % sit 212 px behind the CTA (`ja-m42-neo-challenge?step=11`, stageFits FAIL; 2 % of listening_build) — now reproducible in one call with `scripts/lane/sim-proof.sh` | next layout lane | queued |
