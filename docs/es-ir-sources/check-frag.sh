...
REPO=/Users/lichfield/Documents/projects/lingle/lingo
...
m15 = open("/Users/lichfield/Documents/projects/lingle/lingo/src/features/languages/es/curriculum/ir/m15.ir.yaml").read()
def block(n):
