...
| 58 | 58 | Build しつもんに こたえてみない | "Is ni correct here? And why" | content — correct as authored: こたえる takes に (質問に答える); を is the foil | fixed 4c3152e1 — one line added to m30-neo-10's kara-because rule card (the lesson that introduces こたえる) stating it takes に for the thing answered |
