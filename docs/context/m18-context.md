# Authoring context pack — module m18

Auto-generated from courseAtoms.ts. The learner arriving at m18 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m18
...
- あまい 🍬 — sweet (seen ~1×, CEJC #383)
- やさい 🥕 — vegetable (seen ~1×, CEJC #411)
...
- どあ — door (seen ~1×)
- ぷりん — pudding (seen ~1×)
- うるさい 📢 — noisy, annoying (seen ~1×)
- さいふ 👛 — wallet (seen ~1×)
- おかあさん 👩 — (honorable) mother (seen ~2×, CEJC #189)
- とし 📅 — year (seen ~2×, CEJC #494)
- ぱん — bread (seen ~2×)
- ぴあの — piano (seen ~2×)
- ぺん — pen (seen ~2×)
- いつつ 5️⃣ — five (seen ~2×)
- とお 🔟 — ten (seen ~2×)
- よっつ 4️⃣ — four (seen ~2×)
- まいばん 🌙 — every night (seen ~2×)
- まいあさ 🌅 — every morning (seen ~2×)
- あかい 🟥 — red (seen ~2×)
- あお 🔵 — blue (seen ~2×)
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m17], canon: COURSE_CANON,
