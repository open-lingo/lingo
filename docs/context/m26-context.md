# Authoring context pack — module m26

Auto-generated from courseAtoms.ts. The learner arriving at m26 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m26
...
- ぷりん — pudding (seen ~2×)
- ことば 🔤 — word, language (seen ~3×, CEJC #353)
- えいご 🇺🇸 — English language (seen ~3×, CEJC #464)
- あおい 🟦 — blue (seen ~3×)
- しょうゆ 🍶 — soy sauce (seen ~3×)
- なく 🐦 — animal noise. to chirp, roar or croak etc. (seen ~3×)
- ちがいます — that's not right (polite) (seen ~3×)
- おもい 🏋️ — heavy (seen ~4×, CEJC #470)
- あい — love (seen ~4×)
- えび — shrimp (seen ~4×)
- ぞう — elephant (seen ~4×)
- どあ — door (seen ~4×)
- いりぐち 🚪 — entrance (seen ~4×)
- まいばん 🌙 — every night (seen ~4×)
- まいあさ 🌅 — every morning (seen ~4×)
- せいと 🎒 — pupil (seen ~4×)
- まち 🏘️ — town, city (seen ~4×)
- さいふ 👛 — wallet (seen ~4×)
- ちかく 📍 — near (seen ~4×)
- さかな 🐟 — fish (seen ~4×)
...
- いちばん 🥇 — best, first (seen ~5×, CEJC #158)
- はやい ⏰ — early (seen ~5×, CEJC #184)
...
- **Verb MCQ/build distractors:** draw from OTHER taught verbs (cross-verb
  confusion), never invented non-words. Pool: あそぶ / かく / いく / みる / よむ / たべる / のむ / ある / かかる / かける / する / つける / できる / なる / やる / のる / すむ / はたらく / はいる / でる / わかる / きる / とる / ふく / さく / うる / いる / かえる / ひく / まつ / おしえる / くる / うたう / あるく / およぐ / つく / しる / みがく / たつ / きく / みせる / おぼえる / いう / おもう / はなす / かう / ちがう / ふる / みえる / きこえる.
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m25], canon: COURSE_CANON,
