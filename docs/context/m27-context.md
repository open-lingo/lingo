# Authoring context pack — module m27

Auto-generated from courseAtoms.ts. The learner arriving at m27 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m27
...
- おかね 💰 — money (seen ~1×, CEJC #239)
- つよい 💪 — powerful (seen ~1×, CEJC #316)
- からい 🌶️ — spicy (seen ~1×, CEJC #498)
- ひろい 🏜️ — spacious, wide (seen ~1×, CEJC #499)
- おそい 🐢 — late, slow (seen ~1×, CEJC #509)
- つくえ 🪑 — desk (seen ~1×)
- よわい 🪶 — weak (seen ~1×)
- かみ 📄 — paper (seen ~1×)
...
- なく 🐦 — animal noise. to chirp, roar or croak etc. (seen ~4×)
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m26], canon: COURSE_CANON,
