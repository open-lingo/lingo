# Authoring context pack — module m21

Auto-generated from courseAtoms.ts. The learner arriving at m21 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m21
...
- へや 🚪 — room (seen ~1×, CEJC #377)
- おなか 🫃 — stomach (seen ~1×, CEJC #405)
- おにいさん 👨 — (honorable) older brother (seen ~1×, CEJC #451)
- おねえさん 👩 — (honorable) older sister (seen ~1×, CEJC #458)
- くち 👄 — mouth, opening (seen ~1×, CEJC #512)
- あい — love (seen ~1×)
- あおい 🟦 — blue (seen ~1×)
...
- おかあさん 👩 — (honorable) mother (seen ~2×, CEJC #189)
...
- **Particle cloze options:** the sibling particles — か / は / が / と / の / も / で / を / へ / より.
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m20], canon: COURSE_CANON,
