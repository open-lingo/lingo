# Authoring context pack — module m17

Auto-generated from courseAtoms.ts. The learner arriving at m17 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m17
...
- とお 🔟 — ten (seen ~1×)
- よっつ 4️⃣ — four (seen ~1×)
- まいばん 🌙 — every night (seen ~1×)
- まいあさ 🌅 — every morning (seen ~1×)
- あお 🔵 — blue (seen ~1×)
- おんがく 🎵 — music (seen ~1×)
- ぱん — bread (seen ~2×)
- ぴあの — piano (seen ~2×)
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m16], canon: COURSE_CANON,
