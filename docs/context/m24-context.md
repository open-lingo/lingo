# Authoring context pack — module m24

Auto-generated from courseAtoms.ts. The learner arriving at m24 has been taught everything below. **Use ONLY these words as carriers/**
**distractors** (plus this module's new allocation); never introduce a word not listed here or in the allocation (invariant 16).

## Grammar / constructions taught BEFORE m24
...
- えいご 🇺🇸 — English language (seen ~1×, CEJC #464)
- あおい 🟦 — blue (seen ~1×)
- しょうゆ 🍶 — soy sauce (seen ~1×)
- へた 👎 — unskillful (seen ~1×)
- なく 🐦 — animal noise. to chirp, roar or croak etc. (seen ~1×)
- おもい 🏋️ — heavy (seen ~2×, CEJC #470)
- あい — love (seen ~2×)
- どあ — door (seen ~2×)
- ぷりん — pudding (seen ~2×)
- いりぐち 🚪 — entrance (seen ~2×)
- ちかく 📍 — near (seen ~2×)
- ちがいます — that's not right (polite) (seen ~2×)
- へん 🗺️ — area (seen ~3×, CEJC #299)
- あまい 🍬 — sweet (seen ~3×, CEJC #383)
- ぱん — bread (seen ~3×)
- ぴあの — piano (seen ~3×)
- ぺん — pen (seen ~3×)
- せっけん 🧼 — economy (seen ~3×)
...
- いつつ 5️⃣ — five (seen ~3×)
- よっつ 4️⃣ — four (seen ~3×)
- うるさい 📢 — noisy, annoying (seen ~3×)
- あかい 🟥 — red (seen ~3×)
- しります — know (polite) (seen ~3×)
- はなし 💬 — talk, story (seen ~4×, CEJC #99)
...
- **Verb MCQ/build distractors:** draw from OTHER taught verbs (cross-verb
  confusion), never invented non-words. Pool: あそぶ / かく / いく / みる / よむ / たべる / のむ / ある / かかる / する / なる / やる / のる / すむ / はたらく / はいる / でる / わかる / きる / とる / ふく / さく / うる / いる / かえる / ひく / まつ / おしえる / くる / うたう / あるく / およぐ / つく / しる / みがく / たつ / きく / みせる / おぼえる / いう / おもう / はなす / かう / ちがう / ふる.
...
After drafting EACH lesson, before moving to the next:
  ...
  (c) run the guard suite on the lessons drafted SO FAR:
      registerModuleBarGuards({ moduleLabel, lessons: <drafted so far>,
        priorModules: [...m1..m23], canon: COURSE_CANON,
