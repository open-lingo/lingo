...
| §7b glosses carry the form's aspect lexically | same law; ES tables its ambiguous forms | Same law (pinned #51). French forms where English hides whether the event happened: *essayer de* + inf ("was going to / tried to, and didn't") vs *essayer* + N ("tried X, did it"), *j'allais* + inf, *venir de*, *être en train de*, *faillir* + inf ("almost did"). House glosses go in an FR §7b table when the gloss-aspect sweep gains an FR extractor. |
