...
| 5 | m16 | ✅ SHIPPED 2026-07-30 (`ja-m16-neo-10` "やさしい ほんを よむ — the classroom"): V:かく, V:よむ, V:つかう, ノート, きょうしつ, クラス, いみ(意味), A:やさしい(易しい) — no substitutions; yomu-imi rule card; かく un-parked into the trainer pools (99→16), やさしい moved 24→16, new tsukau VERB_ENTRIES row; dead ja-m7-1 (かく/よむ) / ja-m7-kata (ノート) / ja-m13-6-1 (クラス) / ja-m26-5-1 (いみ) / ja-m29-1-1 (つかう) attributions deleted; recognition beats authored WITH the lesson (よむ/やさしい cloze-as-answer, クラス/いみ listening-comp); R3 extended (dict-form beats, statements only) |
| 6 | m16 | ✅ SHIPPED 2026-07-30 (`ja-m16-neo-11` "からだに わるい — habits and health"): V:すう, V:はしる, たばこ, スポーツ, A:わるい, A:よわい + A:たいせつ — ONE substitution: 歯(は) is a homograph LOSER (は resolves to the topic particle; `homographTeaching.test.ts` bans teaching it), deferred to the m22 body cluster; たいせつ substitutes in from the audit's own §6 m16 habits row (な-adj — spends the な-before-ので trap). karada-ni-warui rule card; わるい un-parked 99→16 (its own note called for it), はしる 30→16, new suu VERB_ENTRIES row; recognition beats WITH the lesson (すう cloze-as-answer, よわい/たいせつ listening-comp, わるい via R3's LC); R3 extended (dict-form beats, statements only) |
